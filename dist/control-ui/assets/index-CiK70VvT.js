    ...
    <section class="card" style="margin-bottom: 16px;" aria-label=${u("tabs.work")}>
      ...
      >
        ...
        ${n.length?d`
              <ul style="margin-top: 8px; padding-left: 20px; font-size: 13px;">
                ${n.map((B,K)=>{const Z=Kf(B),ie=B.split(/[/\\]/).pop()??B,we=Z&&i[Z]||ie;return d`
      ...
      <div style="display: flex; flex-wrap: wrap; gap: 16px; margin-bottom: 12px;">
        <div>
          ...
          ${(()=>{const B=I&&I.length>0?I:zf.map(K=>({value:K.value,label:u(K.labelKey)}));return d`<select
              .value=${f}
          ...
          <section class="card">
            ...
            ${Ir(c.trace).length?d`
                  <div style="margin-bottom: 12px;">
                    ${Ir(c.trace).map(B=>d`
                        <a href=${Rr(t,`/api/quotation/download?path=${encodeURIComponent(B)}`)} download=${B} class="btn btn-sm" style="margin-right: 8px; margin-bottom: 6px; text-decoration: none;">
 ...
 */const Mr=(e,t,n)=>{const i=new Map;for(let o=t;o<=n;o++)i.set(e[o],o);return i},Ul=hs(class extends ms{constructor(e){if(super(e),e.type!==gs.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,n){let i;n===void 0?n=t:t!==void 0&&(i=t);const o=[],s=[];let r=0;for(const a of e)o[r]=i?i(a,r):r,s[r]=n(a,r),r++;return{values:s,keys:o}}render(e,t,n){return this.dt(e,t,n).values}update(e,[t,n,i]){const o=Xf(e),{values:s,keys:r}=this.dt(t,n,i);if(!Array.isArray(o))return this.ut=r,s;const a=this.ut??(this.ut=[]),l=[];let c,p,f=0,g=o.length-1,b=0,$=s.length-1;for(;f<=g&&b<=$;)if(o[f]===null)f++;else if(o[g]===null)g--;else if(a[f]===r[b])l[b]=gt(o[f],s[b]),f++,b++;else if(a[g]===r[$])l[$]=gt(o[g],s[$]),g--,$--;else if(a[f]===r[$])l[$]=gt(o[f],s[$]),Xt(e,l[$+1],o[f]),f++,$--;else if(a[g]===r[b])l[b]=gt(o[g],s[b]),Xt(e,o[f],o[g]),g--,b++;else if(c===void 0&&(c=Mr(r,b,$),p=Mr(a,f,g)),c.has(a[f]))if(c.has(a[g])){const k=p.get(r[b]),S=k!==void 0?o[k]:null;if(S===null){const R=Xt(e,o[f]);gt(R,s[b]),l[b]=R}else l[b]=gt(S,s[b]),Xt(e,o[f],S),o[k]=null;b++}else Xi(o[g]),g--;else Xi(o[f]),f++;for(;b<=$;){const k=Xt(e,l[$+1]);gt(k,s[b]),l[b++]=k}for(;f<=g;){const k=o[f++];k!==null&&Xi(k)}return this.ut=r,Vf(e,l),rt}}),pe={messageSquare:d`
  ...
  `}function Og(e){var R;const t=ki(e.configForm,e.agentId),n=((R=t.entry)==null?void 0:R.tools)??{},i=t.globalTools??{},o=n.profile??i.profile??"full",s=n.profile?"agent override":i.profile?"global default":"default",r=Array.isArray(n.allow)&&n.allow.length>0,a=Array.isArray(i.allow)&&i.allow.length>0,l=!!e.configForm&&!e.configLoading&&!e.configSaving&&!r,c=r?[]:Array.isArray(n.alsoAllow)?n.alsoAllow:[],p=r?[]:Array.isArray(n.deny)?n.deny:[],f=r?{allow:n.allow??[],deny:n.deny??[]}:Ag()??void 0,g=Nr.flatMap(I=>I.tools.map(F=>F.id)),b=I=>{const F=_g(I,f),A=zr(I,c),C=zr(I,p);return{allowed:(F||A)&&!C,baseAllowed:F,denied:C}},$=g.filter(I=>b(I).allowed).length,k=(I,F)=>{const A=new Set(c.map(_=>Ye(_)).filter(_=>_.length>0)),C=new Set(p.map(_=>Ye(_)).filter(_=>_.length>0)),q=b(I).baseAllowed,y=Ye(I);F?(C.delete(y),q||A.add(y)):(A.delete(y),C.add(y)),e.onOverridesChange(e.agentId,[...A],[...C])},S=I=>{const F=new Set(c.map(C=>Ye(C)).filter(C=>C.length>0)),A=new Set(p.map(C=>Ye(C)).filter(C=>C.length>0));for(const C of g){const q=b(C).baseAllowed,y=Ye(C);I?(A.delete(y),q||F.add(y)):(F.delete(y),A.add(y))}e.onOverridesChange(e.agentId,[...F],[...A])};return d`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
...
`,e=e.substring($.length+1),p=!0),!p){let R=this.rules.other.nextBulletRegex(S),I=this.rules.other.hrRegex(S),F=this.rules.other.fencesBeginRegex(S),A=this.rules.other.headingBeginRegex(S),C=this.rules.other.htmlBeginRegex(S),q=this.rules.other.blockquoteBeginRegex(S);for(;e;){let y=e.split(`
`,1)[0],_;if($=y,this.options.pedantic?($=$.replace(this.rules.other.listReplaceNesting,"  "),_=$):_=$.replace(this.rules.other.tabCharGlobal,"    "),F.test($)||A.test($)||C.test($)||q.test($)||R.test($)||I.test($))break;if(_.search(this.rules.other.nonSpaceChar)>=S||!$.trim())g+=`
  ...
  `}function rv(e){var S,R,I,F;const t=e.connected,n=e.sending||e.stream!==null,i=!!(e.canAbort&&e.onAbort),o=(R=(S=e.sessions)==null?void 0:S.sessions)==null?void 0:R.find(A=>A.key===e.sessionKey),s=e.showThinking&&(o==null?void 0:o.reasoningLevel)!=="off",r={name:e.assistantName,avatar:e.assistantAvatar??e.assistantAvatarUrl??null},a=(((I=e.attachments)==null?void 0:I.length)??0)>0;(F=e.uploadedFile)!=null&&F.file_name;const l=e.connected?u(a?"chat.ui.compose.placeholder.withImages":"chat.ui.compose.placeholder.default"):u("chat.ui.compose.placeholder.disconnected"),c=e.splitRatio??.6,p=!!(e.sidebarOpen&&e.onCloseSidebar),f=d`
    ...
    >
      ...
      ${Ul(lv(e),A=>A.key,A=>A.kind==="divider"?d`
            ...
            `:A.kind==="reading-indicator"?Km(r):A.kind==="stream"?Hm(A.text,A.startedAt,e.onOpenSidebar,r):A.kind==="group"?jm(A,{onOpenSidebar:e.onOpenSidebar,showReasoning:s,assistantName:e.assistantName,assistantAvatar:r.avatar}):w)}
    </div>
  `,g=A=>{var C;A.preventDefault(),A.stopPropagation(),A.dataTransfer&&(A.dataTransfer.dropEffect="copy"),(C=e.onComposeDragOver)==null||C.call(e)},b=A=>{var C;A.preventDefault(),A.stopPropagation(),A.dataTransfer&&(A.dataTransfer.dropEffect="copy"),(C=e.onComposeDragOver)==null||C.call(e)},$=A=>{var y;const C=A.currentTarget,q=A.relatedTarget;q!=null&&(C.contains(q)||(y=e.onComposeDragLeave)==null||y.call(e))},k=A=>{var q,y,_;A.preventDefault(),A.stopPropagation(),(q=e.onComposeDragLeave)==null||q.call(e);const C=(_=(y=A.dataTransfer)==null?void 0:y.files)!=null&&_.length?ev(A.dataTransfer.files):null;C&&e.onComposeDrop&&e.onComposeDrop(C)};return d`
    <section
...
\`\`\``)}})}
        ...
        <div class="chat-compose__row">
          <label class="field chat-compose__field">
            ...
            <textarea
              ...
              @input=${A=>{const C=A.target;ca(C),e.onDraftChange(C.value)}}
              @paste=${A=>iv(A,e)}
              placeholder=${l}
            ></textarea>
          </label>
  ...
  `};function Tt(e){const{schema:t,value:n,path:i,hints:o,unsupported:s,disabled:r,onPatch:a}=e,l=e.showLabel??!0,c=Te(t),p=Ee(i,o),f=(p==null?void 0:p.label)??t.title??Ze(String(i.at(-1))),g=(p==null?void 0:p.help)??t.description,b=qo(i);if(s.has(b))return d`<div class="cfg-field cfg-field--error">
        ...
        <div class="cfg-field">
          ...
          <div class="cfg-segmented">
            ${R.map(q=>d`
              <button
                type="button"
                class="cfg-segmented__btn ${q===C||String(q)===String(C)?"active":""}"
                ?disabled=${r}
                @click=${()=>a(i,q)}
              >
                ${String(q)}
      ...
      `}if(I&&R.length>5)return fa({...e,options:R,value:n??t.default});const F=new Set(k.map(C=>Te(C)).filter(Boolean)),A=new Set([...F].map(C=>C==="integer"?"number":C));if([...A].every(C=>["string","number","boolean"].includes(C))){const C=A.has("string"),q=A.has("number");if(A.has("boolean")&&A.size===1)return Tt({...e,schema:{...t,type:"boolean",anyOf:void 0,oneOf:void 0}});if(C||q)return pa({...e,inputType:q&&!C?"number":"text"})}}if(t.enum){const $=t.enum;if($.length<=5){const k=n??t.default;return d`
        <div class="cfg-field">
          ${l?d`<label class="cfg-field__label">${f}</label>`:w}
          ${g?d`<div class="cfg-field__help">${g}</div>`:w}
          <div class="cfg-segmented">
                    ...
                    <tbody>
                      ${G.map(N=>d`
                          <tr style=${s===N.id?"background: var(--bg-secondary, #f5f5f5);":""}>
                            ...
                            <td style="padding: 6px 8px; border: 1px solid var(--border);">${wa(N.name)}</td>
                            <td style="padding: 6px 8px; border: 1px solid var(--border);">${N.source??"-"}</td>
                            <td style="padding: 6px 8px; border: 1px solid var(--border);">${Av(N.created_at)}</td>
    ...
    <section class="grid grid-cols-2" aria-label=${u("tabs.sessions")}>
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        ${t&&i.length===0?d`<p class="muted" style="margin-top: 12px;">${u("procurement.loading")}</p>`:_.length===0?d`<p class="muted" style="margin-top: 12px;">${i.length===0?u("procurement.noSuggestions"):u("procurement.noPending")}</p>`:d`
                <div class="muted" style="font-size: 12px; margin-top: 10px;">
                  ${u("procurement.total",{total:String(z)})}
                </div>
                <div style="overflow-x: auto; margin-top: 8px;">
                  <table style="width: 100%; border-collapse: collapse; font-size: 12px;">
                    <thead>
  ...
  `}const xy=/^data:/i,ky=/^https?:\/\//i;function Sy(e){var a,l;const t=((a=e.agentsList)==null?void 0:a.agents)??[],n=Ba(e.sessionKey),i=(n==null?void 0:n.agentId)??((l=e.agentsList)==null?void 0:l.defaultId)??"main",o=t.find(c=>c.id===i),s=o==null?void 0:o.identity,r=(s==null?void 0:s.avatarUrl)??(s==null?void 0:s.avatar);if(r)return xy.test(r)||ky.test(r)?r:s==null?void 0:s.avatarUrl}function _y(e){var $,k,S,R,I,F,A,C,q;const t=e.presenceEntries.length,n=(($=e.sessionsResult)==null?void 0:$.count)??null,i=((k=e.cronStatus)==null?void 0:k.nextWakeAtMs)??null,o=e.connected?null:u("chat.disconnected"),s=e.tab==="chat",r=s&&(e.settings.chatFocusMode||e.onboarding),a=e.onboarding?!1:e.settings.chatShowThinking,l=Sy(e),c=e.chatAvatarUrl??l??null,p=e.configForm??((S=e.configSnapshot)==null?void 0:S.config),f=jt(e.basePath??""),g=e.agentsSelectedId??((R=e.agentsList)==null?void 0:R.defaultId)??((A=(F=(I=e.agentsList)==null?void 0:I.agents)==null?void 0:F[0])==null?void 0:A.id)??null,b=xt.getLocale();return d`
    <div class="shell ${s?"shell--chat":""} ${r?"shell--chat-focus":""} ${e.settings.navCollapsed?"shell--nav-collapsed":""} ${e.onboarding?"shell--onboarding":""}">
      ...
      <aside class="nav ${e.settings.navCollapsed?"nav--collapsed":""}">
        ${sp.map(y=>{const _=e.settings.navGroupsCollapsed[y.label]??!1,T=y.tabs.some(z=>z===e.tab);return d`
            <div class="nav-group ${_&&!T?"nav-group--collapsed":""}">
              <button
                class="nav-label"
                @click=${()=>{const z={...e.settings.navGroupsCollapsed};z[y.label]=!_,e.applySettings({...e.settings,navGroupsCollapsed:z})}}
                aria-expanded=${!_}
              >
      ...
      <main class="content ${s?"content--chat":""}">
        ...
        ${e.tab==="sessions"?Rv({basePath:e.basePath,loading:e.procurementLoading,error:e.procurementError,suggestions:e.procurementSuggestions,selectedKeys:e.procurementSelectedKeys,approvedKeys:e.procurementApprovedKeys,approveBusy:e.procurementApproveBusy,approveResult:e.procurementApproveResult,filterQuery:e.procurementFilterQuery,sortBy:e.procurementSortBy,sortDir:e.procurementSortDir,page:e.procurementPage,pageSize:e.procurementPageSize,replenishmentDrafts:e.replenishmentDrafts,replenishmentDetail:e.replenishmentDetail,replenishmentDetailId:e.replenishmentDetailId,replenishmentLoading:e.replenishmentLoading,replenishmentError:e.replenishmentError,replenishmentConfirmBusy:e.replenishmentConfirmBusy,replenishmentConfirmResult:e.replenishmentConfirmResult,replenishmentInputLines:e.replenishmentInputLines,replenishmentCreateBusy:e.replenishmentCreateBusy,onReplenishmentLineChange:(y,_,T)=>e.onReplenishmentLineChange(y,_,T),onReplenishmentAddLine:()=>e.onReplenishmentAddLine(),onReplenishmentRemoveLine:y=>e.onReplenishmentRemoveLine(y),onCreateReplenishmentDraft:()=>e.createProcurementReplenishmentDraft(),onReplenishmentRefresh:()=>e.loadProcurementReplenishment(),onSelectReplenishmentDraft:y=>{e.loadProcurementReplenishmentDetail(y)},onConfirmReplenishment:y=>{typeof window<"u"&&!window.confirm(u("replenishment.confirmPrompt"))||e.confirmProcurementReplenishment(y)},onDeleteReplenishmentDraft:y=>{typeof window<"u"&&!window.confirm(u("replenishment.deleteConfirm"))||e.deleteProcurementReplenishmentDraft(y)},onClearReplenishmentDetail:()=>{e.replenishmentDetail=null,e.replenishmentDetailId=null},onRefresh:()=>(e.procurementPage=1,e.loadProcurementSuggestions()),onToggleSelect:y=>{e.procurementSelectedKeys.includes(y)?e.procurementSelectedKeys=e.procurementSelectedKeys.filter(_=>_!==y):e.procurementSelectedKeys=[...e.procurementSelectedKeys,y]},onApprove:y=>{if(typeof window<"u"&&!window.confirm(u("procurement.approveConfirm")))return;const _=[{product_key:y.product_key,product_name:y.product_name,specification:y.specification,shortfall:y.shortfall,code:y.code}];ur(e,_).then(T=>{T&&(T.approved_count??0)>0&&(e.procurementApprovedKeys=[...e.procurementApprovedKeys,De(y)])})},onApproveBatch:()=>{const y=e.procurementSuggestions.filter(T=>e.procurementSelectedKeys.includes(De(T)));if(y.length===0||typeof window<"u"&&!window.confirm(u("procurement.approveBatchConfirm",{count:String(y.length)})))return;const _=y.map(T=>({product_key:T.product_key,product_name:T.product_name,specification:T.specification,shortfall:T.shortfall,code:T.code}));ur(e,_).then(T=>{if(T&&(T.approved_count??0)>0){const z=y.map(P=>De(P));e.procurementApprovedKeys=[...e.procurementApprovedKeys,...z],e.procurementSelectedKeys=e.procurementSelectedKeys.filter(P=>!z.includes(P))}})},onFilterQueryChange:y=>{e.procurementFilterQuery=y,e.procurementPage=1},onSortByChange:y=>{e.procurementSortBy=y,e.procurementPage=1},onSortDirChange:y=>{e.procurementSortDir=y,e.procurementPage=1},onPageChange:y=>{e.procurementPage=Math.max(1,y)},onPageSizeChange:y=>{e.procurementPageSize=Math.max(1,y),e.procurementPage=1}}):w}

        ${jf(e)}

        ${e.tab==="cron"?Tv({basePath:e.basePath,loading:e.fulfillDraftsLoading,error:e.fulfillDraftsError,drafts:e.fulfillDrafts,detail:e.fulfillDetail,detailId:e.fulfillDetailId,confirmBusy:e.fulfillConfirmBusy,confirmResult:e.fulfillConfirmResult,filterQuery:e.fulfillFilterQuery,sortBy:e.fulfillSortBy,sortDir:e.fulfillSortDir,page:e.fulfillPage,pageSize:e.fulfillPageSize,onRefresh:()=>(e.fulfillPage=1,e.loadFulfillDrafts()),onSelectDraft:y=>Yd(e,y),onConfirm:y=>{var j;const _=e.fulfillDetailId===y?e.fulfillDetail:null,T=((j=_==null?void 0:_.lines)==null?void 0:j.length)??0,z=((_==null?void 0:_.lines)??[]).reduce((H,G)=>H+Number(G.amount??0),0),P=T>0?u("fulfill.confirmPrompt",{count:String(T),amount:z.toFixed(2)}):u("fulfill.confirmPromptSimple");typeof window<"u"&&window.confirm(P)&&Zd(e,y).then(H=>{H!=null&&H.order_id&&e.loadProcurementSuggestions()})},onClearDetail:()=>{e.fulfillDetail=null,e.fulfillDetailId=null,e.fulfillConfirmResult=null},onFilterQueryChange:y=>{e.fulfillFilterQuery=y,e.fulfillPage=1},onSortByChange:y=>{e.fulfillSortBy=y,e.fulfillPage=1},onSortDirChange:y=>{e.fulfillSortDir=y,e.fulfillPage=1},onPageChange:y=>{e.fulfillPage=Math.max(1,y)},onPageSizeChange:y=>{e.fulfillPageSize=Math.max(1,y),e.fulfillPage=1}}):w}

        ${e.tab==="agents"?qg({loading:e.agentsLoading,error:e.agentsError,agentsList:e.agentsList,selectedAgentId:g,activePanel:e.agentsPanel,configForm:p,configLoading:e.configLoading,configSaving:e.configSaving,configDirty:e.configFormDirty,channelsLoading:e.channelsLoading,channelsError:e.channelsError,channelsSnapshot:e.channelsSnapshot,channelsLastSuccess:e.channelsLastSuccess,cronLoading:e.cronLoading,cronStatus:e.cronStatus,cronJobs:e.cronJobs,cronError:e.cronError,agentFilesLoading:e.agentFilesLoading,agentFilesError:e.agentFilesError,agentFilesList:e.agentFilesList,agentFileActive:e.agentFileActive,agentFileContents:e.agentFileContents,agentFileDrafts:e.agentFileDrafts,agentFileSaving:e.agentFileSaving,agentIdentityLoading:e.agentIdentityLoading,agentIdentityError:e.agentIdentityError,agentIdentityById:e.agentIdentityById,agentSkillsLoading:e.agentSkillsLoading,agentSkillsReport:e.agentSkillsReport,agentSkillsError:e.agentSkillsError,agentSkillsAgentId:e.agentSkillsAgentId,skillsFilter:e.skillsFilter,onRefresh:async()=>{var _,T;await Qo(e);const y=((T=(_=e.agentsList)==null?void 0:_.agents)==null?void 0:T.map(z=>z.id))??[];y.length>0&&qa(e,y)},onSelectAgent:y=>{e.agentsSelectedId!==y&&(e.agentsSelectedId=y,e.agentFilesList=null,e.agentFilesError=null,e.agentFilesLoading=!1,e.agentFileActive=null,e.agentFileContents={},e.agentFileDrafts={},e.agentSkillsReport=null,e.agentSkillsError=null,e.agentSkillsAgentId=null,za(e,y),e.agentsPanel==="files"&&Yi(e,y),e.agentsPanel==="skills"&&Vn(e,y))},onSelectPanel:y=>{var _;e.agentsPanel=y,y==="files"&&g&&((_=e.agentFilesList)==null?void 0:_.agentId)!==g&&(e.agentFilesList=null,e.agentFilesError=null,e.agentFileActive=null,e.agentFileContents={},e.agentFileDrafts={},Yi(e,g)),y==="skills"&&g&&Vn(e,g),y==="channels"&&Re(e,!1),y==="cron"&&e.loadCron()},onLoadFiles:y=>Yi(e,y),onSelectFile:y=>{e.agentFileActive=y,g&&dg(e,g,y)},onFileDraftChange:(y,_)=>{e.agentFileDrafts={...e.agentFileDrafts,[y]:_}},onFileReset:y=>{const _=e.agentFileContents[y]??"";e.agentFileDrafts={...e.agentFileDrafts,[y]:_}},onFileSave:y=>{if(!g)return;const _=e.agentFileDrafts[y]??e.agentFileContents[y]??"";ug(e,g,y,_)},onToolsProfileChange:(y,_,T)=>{var H;if(!p)return;const z=(H=p.agents)==null?void 0:H.list;if(!Array.isArray(z))return;const P=z.findIndex(G=>G&&typeof G=="object"&&"id"in G&&G.id===y);if(P<0)return;const j=["agents","list",P,"tools"];_?Ce(e,[...j,"profile"],_):Xe(e,[...j,"profile"]),T&&Xe(e,[...j,"allow"])},onToolsOverridesChange:(y,_,T)=>{var H;if(!p)return;const z=(H=p.agents)==null?void 0:H.list;if(!Array.isArray(z))return;const P=z.findIndex(G=>G&&typeof G=="object"&&"id"in G&&G.id===y);if(P<0)return;const j=["agents","list",P,"tools"];_.length>0?Ce(e,[...j,"alsoAllow"],_):Xe(e,[...j,"alsoAllow"]),T.length>0?Ce(e,[...j,"deny"],T):Xe(e,[...j,"deny"])},onConfigReload:()=>Ge(e),onConfigSave:()=>Qn(e),onChannelsRefresh:()=>Re(e,!1),onCronRefresh:()=>e.loadCron(),onSkillsFilterChange:y=>e.skillsFilter=y,onSkillsRefresh:()=>{g&&Vn(e,g)},onAgentSkillToggle:(y,_,T)=>{var L,Y,ge;if(!p)return;const z=(L=p.agents)==null?void 0:L.list;if(!Array.isArray(z))return;const P=z.findIndex(Q=>Q&&typeof Q=="object"&&"id"in Q&&Q.id===y);if(P<0)return;const j=z[P],H=_.trim();if(!H)return;const G=((ge=(Y=e.agentSkillsReport)==null?void 0:Y.skills)==null?void 0:ge.map(Q=>Q.name).filter(Boolean))??[],ne=(Array.isArray(j.skills)?j.skills.map(Q=>String(Q).trim()).filter(Boolean):void 0)??G,be=new Set(ne);T?be.add(H):be.delete(H),Ce(e,["agents","list",P,"skills"],[...be])},onAgentSkillsClear:y=>{var z;if(!p)return;const _=(z=p.agents)==null?void 0:z.list;if(!Array.isArray(_))return;const T=_.findIndex(P=>P&&typeof P=="object"&&"id"in P&&P.id===y);T<0||Xe(e,["agents","list",T,"skills"])},onAgentSkillsDisableAll:y=>{var z;if(!p)return;const _=(z=p.agents)==null?void 0:z.list;if(!Array.isArray(_))return;const T=_.findIndex(P=>P&&typeof P=="object"&&"id"in P&&P.id===y);T<0||Ce(e,["agents","list",T,"skills"],[])},onModelChange:(y,_)=>{var G;if(!p)return;const T=(G=p.agents)==null?void 0:G.list;if(!Array.isArray(T))return;const z=T.findIndex(N=>N&&typeof N=="object"&&"id"in N&&N.id===y);if(z<0)return;const P=["agents","list",z,"model"];if(!_){Xe(e,P);return}const j=T[z],H=j==null?void 0:j.model;if(H&&typeof H=="object"&&!Array.isArray(H)){const N=H.fallbacks,ne={primary:_,...Array.isArray(N)?{fallbacks:N}:{}};Ce(e,P,ne)}else Ce(e,P,_)},onModelFallbacksChange:(y,_)=>{var L;if(!p)return;const T=(L=p.agents)==null?void 0:L.list;if(!Array.isArray(T))return;const z=T.findIndex(Y=>Y&&typeof Y=="object"&&"id"in Y&&Y.id===y);if(z<0)return;const P=["agents","list",z,"model"],j=T[z],H=_.map(Y=>Y.trim()).filter(Boolean),G=j.model,ne=(()=>{if(typeof G=="string")return G.trim()||null;if(G&&typeof G=="object"&&!Array.isArray(G)){const Y=G.primary;if(typeof Y=="string")return Y.trim()||null}return null})();if(H.length===0){ne?Ce(e,P,ne):Xe(e,P);return}Ce(e,P,ne?{primary:ne,fallbacks:H}:{fallbacks:H})}}):w}

        ${e.tab==="skills"?wy({loading:e.skillsLoading,report:e.skillsReport,error:e.skillsError,filter:e.skillsFilter,edits:e.skillEdits,messages:e.skillMessages,busyKey:e.skillsBusyKey,onFilterChange:y=>e.skillsFilter=y,onRefresh:()=>kn(e,{clearMessages:!0}),onToggle:(y,_)=>np(e,y,_),onEdit:(y,_)=>tp(e,y,_),onSaveKey:y=>ip(e,y),onInstall:(y,_,T)=>op(e,y,_,T)}):w}

        ${e.tab==="nodes"?ly({loading:e.nodesLoading,nodes:e.nodes,devicesLoading:e.devicesLoading,devicesError:e.devicesError,devicesList:e.devicesList,configForm:e.configForm??((q=e.configSnapshot)==null?void 0:q.config),configLoading:e.configLoading,configSaving:e.configSaving,configDirty:e.configFormDirty,configFormMode:e.configFormMode,execApprovalsLoading:e.execApprovalsLoading,execApprovalsSaving:e.execApprovalsSaving,execApprovalsDirty:e.execApprovalsDirty,execApprovalsSnapshot:e.execApprovalsSnapshot,execApprovalsForm:e.execApprovalsForm,execApprovalsSelectedAgent:e.execApprovalsSelectedAgent,execApprovalsTarget:e.execApprovalsTarget,execApprovalsTargetNodeId:e.execApprovalsTargetNodeId,onRefresh:()=>gi(e),onDevicesRefresh:()=>dt(e),onDeviceApprove:y=>Ou(e,y),onDeviceReject:y=>Bu(e,y),onDeviceRotate:(y,_,T)=>Uu(e,{deviceId:y,role:_,scopes:T}),onDeviceRevoke:(y,_)=>zu(e,{deviceId:y,role:_}),onLoadConfig:()=>Ge(e),onLoadExecApprovals:()=>{const y=e.execApprovalsTarget==="node"&&e.execApprovalsTargetNodeId?{kind:"node",nodeId:e.execApprovalsTargetNodeId}:{kind:"gateway"};return ss(e,y)},onBindDefault:y=>{y?Ce(e,["tools","exec","node"],y):Xe(e,["tools","exec","node"])},onBindAgent:(y,_)=>{const T=["agents","list",y,"tools","exec","node"];_?Ce(e,T,_):Xe(e,T)},onSaveBindings:()=>Qn(e),onExecApprovalsTargetChange:(y,_)=>{e.execApprovalsTarget=y,e.execApprovalsTargetNodeId=_,e.execApprovalsSnapshot=null,e.execApprovalsForm=null,e.execApprovalsDirty=!1,e.execApprovalsSelectedAgent=null},onExecApprovalsSelectAgent:y=>{e.execApprovalsSelectedAgent=y},onExecApprovalsPatch:(y,_)=>Gu(e,y,_),onExecApprovalsRemove:y=>Wu(e,y),onSaveExecApprovals:()=>{const y=e.execApprovalsTarget==="node"&&e.execApprovalsTargetNodeId?{kind:"node",nodeId:e.execApprovalsTargetNodeId}:{kind:"gateway"};return ju(e,y)}}):w}
...
//# sourceMappingURL=index-CiK70VvT.js.map
