...
`);l=g.pop()??"";for(const b of g){if(!b.startsWith("data: "))continue;const $=b.slice(6).trim();if(!$)continue;const k=Z(JSON.parse($),t,"stream_event"),S=ot(k.type,t,"stream_event.type");if(S==="stage"){const E=ve(k.stage)??Number(k.stage);if(!Number.isFinite(E))throw new ce(t,"stage must be a number");e.workProgressStage=E}else if(S==="result"){const E=xo(k.payload,t);ko(e,E),c=!0;break}}if(c)break}if(!c&&l.startsWith("data: ")){const p=l.slice(6).trim();if(p){const f=Z(JSON.parse(p),t,"stream_event_tail");if(f.type==="result"){const g=xo(f.payload,t);ko(e,g),c=!0}}}if(!c)throw new ce(t,"stream ended without result event")}catch(s){const r=jt(e);throw r.cancelRequested?new Error("__WORK_CANCELLED__"):si(s)&&r.timeoutReached?new je("请求超时"):si(s)?new Error("请求已中断"):s instanceof ce||s instanceof je?s:s instanceof Error&&/network|failed to fetch|load failed/i.test(s.message)?new je(s.message):s}finally{o()}}function Rf(e,t){if(e===404||e===410)return!0;const n=ye(t,"").toLowerCase();return n.includes("run_id")||n.includes("run id")}async function Lf(e,t,n){const i="/api/work/resume",{signal:o,close:s}=Nl(e,wf);try{const r=await fetch(Sn(e.basePath,i),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({run_id:t,selections:n}),credentials:"same-origin",signal:o}),a=await r.json().catch(()=>({}));if(!r.ok){if(Rf(r.status,a))throw new $o(ye(a,"run_id 已失效"));const c=ye(a,`HTTP ${r.status}`);throw Fl(r.status)?new je(c):new Error(c)}const l=xo(a,i);ko(e,l)}catch(r){const a=jt(e);throw a.cancelRequested?new Error("__WORK_CANCELLED__"):r instanceof $o?r:si(r)&&a.timeoutReached?new je("请求超时"):si(r)?new Error("请求已中断"):r instanceof ce||r instanceof je?r:r instanceof Error&&/network|failed to fetch|load failed/i.test(r.message)?new je(r.message):r}finally{s()}}function If(e){var n;const t=jt(e);t.cancelRequested=!0,(n=t.controller)==null||n.abort("user_cancel"),fs(e),e.workRunning=!1}async function Ol(e){if(!e.workFilePaths.length){e.workError="请先上传至少一个报价单文件";return}const t=jt(e);t.cancelRequested=!1,e.workRunning=!0,e.workError=null,e.workResult=null,e.workRunId=null,e.workPendingChoices=[],e.workSelections={},e.workPendingQuotationDraft=null,e.workQuotationDraftSaveStatus=null,oi(e,"running");let n=0;try{for(;;){n+=1;try{await Ef(e,"/api/work/run-stream");break}catch(i){if(i instanceof Error&&i.message==="__WORK_CANCELLED__"){fs(e);break}if(i instanceof je&&n<=Il){await Ml(Pl*n);continue}const o=i instanceof ce||i instanceof Error?i.message:String(i);Tf(e,o);break}}}finally{e.workRunning=!1}}async function Bl(e){const t=e.workRunId;if(!t||e.workPendingChoices.length===0){e.workError="缺少可继续的 run_id，请重新执行。",Ut(e,"error");return}const n=e.workPendingChoices.map(s=>({item_id:s.id,selected_code:e.workSelections[s.id]??"__OOS__"})),i=jt(e);i.cancelRequested=!1,e.workRunning=!0,e.workError=null,oi(e,"resuming");let o=0;try{for(;;){o+=1;try{await Lf(e,t,n);break}catch(s){if(s instanceof Error&&s.message==="__WORK_CANCELLED__"){fs(e);break}if(s instanceof $o){ps(e),e.workResult={success:!1,error:s.message},e.workError=oe("继续流程",s.message,"当前待选项无法继续提交","请重新执行一次 Work 流程"),Ut(e,"error");break}if(s instanceof je&&o<=Il){await Ml(Pl*o);continue}const r=s instanceof ce||s instanceof Error?s.message:String(s);e.workResult={success:!1,error:r},e.workError=oe("继续流程",r,"本次续跑失败，尚未生成完整结果","点击“重试”继续，或重新执行 Work"),Ut(e,"error");break}}}finally{e.workRunning=!1}}async function Pf(e){if(e.workRunId&&e.workPendingChoices.length>0){await Bl(e);return}await Ol(e)}async function Df(e){const t=(e.workTextInput||"").trim();if(!t)return e.workTextError="请输入产品描述文字",!1;e.workTextGenerating=!0,e.workTextError=null;try{const n=await fetch(Sn(e.basePath,"/api/quotation/from-text"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:t}),credentials:"same-origin"}),i=await n.json().catch(()=>({}));if(!n.ok){let a=typeof i.detail=="string"?i.detail:ye(i,`HTTP ${n.status}`);return n.status===405&&(a="Method Not Allowed：该接口需 POST。请确认使用 python start.py 或 run_backend.py 启动前后端一体服务，且未通过仅支持 GET 的静态托管访问页面。"),e.workTextError=a,!1}const o=i&&typeof i.data=="object"?i.data:i,s=[],r={};if(Array.isArray(o.file_paths)){const a=Array.isArray(o.file_names)?o.file_names:[];o.file_paths.forEach((l,c)=>{if(typeof l!="string"||!l.trim())return;const p=l.trim();s.push(p);const f=typeof a[c]=="string"?a[c]:"";r[p]=f||p.split(/[/\\]/).pop()||p})}if(typeof o.file_path=="string"&&o.file_path.trim()){const a=o.file_path.trim();s.includes(a)||s.push(a);const l=typeof o.file_name=="string"?o.file_name:"";r[a]=l||a.split(/[/\\]/).pop()||a}if(!s.length)return e.workTextError="接口未返回 file_path/file_paths",!1;for(const a of s){e.workFilePaths.includes(a)||(e.workFilePaths=[...e.workFilePaths,a]);const l=Dl(a);if(l){const c=(r[a]||"").trim()||a.split(/[/\\]/).pop()||a;e.workOriginalFileNamesByPath={...e.workOriginalFileNamesByPath,[l]:c}}}return e.workTextError=null,!0}catch(n){const i=n instanceof Error?n.message:String(n);return e.workTextError=oe("从文字生成报价单",i,"未生成文件","请检查网络或后端后重试"),!1}finally{e.workTextGenerating=!1}}async function Mf(e){try{const t=Sn(e.basePath,"/api/config/price-levels"),n=await fetch(t);if(!n.ok)throw new Error(`HTTP ${n.status}`);const i=await n.json();i.success&&Array.isArray(i.data)&&(e.workPriceLevelOptions=i.data)}catch(t){console.warn("[work] 加载价格档位失败，使用本地默认值",t)}}async function Ff(e){var n;const t=e.workPendingQuotationDraft;if(!((n=t==null?void 0:t.lines)!=null&&n.length))return e.workQuotationDraftSaveStatus={status:"error",error:"无报价明细可保存"},!1;e.workQuotationDraftSaveStatus={status:"saving"};try{const i=await fetch(Sn(e.basePath,"/api/quotation-drafts"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:xf(e,t),source:t.source||"file",file_path:t.file_path??void 0,lines:t.lines.map(f=>({product_name:f.product_name??"",specification:f.specification??"",qty:Number(f.qty)||0,code:f.code??"",quote_name:f.quote_name??"",unit_price:f.unit_price!=null?Number(f.unit_price):null,amount:f.amount!=null?Number(f.amount):null,available_qty:Number(f.available_qty)||0,shortfall:Number(f.shortfall)||0,is_shortage:f.is_shortage?1:0,match_source:f.match_source??null}))}),credentials:"same-origin"}),o=await i.json().catch(()=>({}));if(!i.ok)return e.workQuotationDraftSaveStatus={status:"error",error:oe("保存报价单",ye(o,`HTTP ${i.status}`),"报价单仍停留在待保存状态","点击“重试”再次保存")},!1;const s=Z(o,"/api/quotation-drafts"),r=Xo(s.success),a=Z(s.data,"/api/quotation-drafts","data"),l=ot(a.draft_no,"/api/quotation-drafts","data.draft_no"),c=ve(a.draft_id)??Number(a.draft_id),p=Number.isFinite(c)?c:0;if(r===!1)throw new ce("/api/quotation-drafts","success is false");return e.workQuotationDraftSaveStatus={status:"ok",draft_no:l,draft_id:p},e.workPendingQuotationDraft=null,!0}catch(i){const o=i instanceof ce||i instanceof Error?i.message:String(i);return e.workQuotationDraftSaveStatus={status:"error",error:oe("保存报价单",o,"报价单仍停留在待保存状态","检查数据后重试")},!1}}function Nf(e){e.basePath=vp(),vf(e),Mf(e),gp(e),$p(e,!0),yp(e),bp(e),window.addEventListener("popstate",e.popStateHandler),Ll(e),Ud(e),e.tab==="logs"&&Ho(e),e.tab==="debug"&&Go(e)}function Of(e){Pd(e)}function Bf(e){var t;window.removeEventListener("popstate",e.popStateHandler),zd(e),jo(e),Wo(e),wp(e),(t=e.topbarObserver)==null||t.disconnect(),e.topbarObserver=null}function Uf(e,t){if(!(e.tab==="chat"&&e.chatManualRefreshInFlight)){if(e.tab==="chat"&&(t.has("chatMessages")||t.has("chatToolMessages")||t.has("chatStream")||t.has("chatLoading")||t.has("tab"))){const n=t.has("tab"),i=t.has("chatLoading")&&t.get("chatLoading")===!0&&!e.chatLoading;$n(e,n||i||!e.chatHasAutoScrolled)}e.tab==="logs"&&(t.has("logsEntries")||t.has("logsAutoFollow")||t.has("tab"))&&e.logsAutoFollow&&e.logsAtBottom&&Ua(e,t.has("tab")||t.has("logsAutoFollow"))}}const zf=[{value:"FACTORY_INC_TAX",labelKey:"work.priceLevels.FACTORY_INC_TAX"},{value:"FACTORY_EXC_TAX",labelKey:"work.priceLevels.FACTORY_EXC_TAX"},{value:"PURCHASE_EXC_TAX",labelKey:"work.priceLevels.PURCHASE_EXC_TAX"},{value:"A_MARGIN",labelKey:"work.priceLevels.A_MARGIN"},{value:"A_QUOTE",labelKey:"work.priceLevels.A_QUOTE"},{value:"B_MARGIN",labelKey:"work.priceLevels.B_MARGIN"},{value:"B_QUOTE",labelKey:"work.priceLevels.B_QUOTE"},{value:"C_MARGIN",labelKey:"work.priceLevels.C_MARGIN"},{value:"C_QUOTE",labelKey:"work.priceLevels.C_QUOTE"},{value:"D_MARGIN",labelKey:"work.priceLevels.D_MARGIN"},{value:"D_QUOTE",labelKey:"work.priceLevels.D_QUOTE"},{value:"D_LOW",labelKey:"work.priceLevels.D_LOW"},{value:"E_MARGIN",labelKey:"work.priceLevels.E_MARGIN"},{value:"E_QUOTE",labelKey:"work.priceLevels.E_QUOTE"}];function Rr(e,t){const n=e!=null&&e.trim()?e.trim().replace(/\/$/,""):"";return n?`${n}${t}`:t}function Lr(e){try{if(typeof e!="string"||!e.trim())return null;const t=e.trim();return t.startsWith("{")&&t.endsWith("}")||t.startsWith("[")&&t.endsWith("]")?JSON.parse(t):null}catch{return null}}function Ir(e){if(!Array.isArray(e))return[];const t=[],n=i=>{if(typeof i!="string"||!i.trim())return;const o=i.replace(/\\/g,"/").split("/").filter(Boolean).pop()??"";o&&!t.includes(o)&&t.push(o)};for(const i of e){const o=i,s=o.type,r=o.content;if(s==="observation"&&typeof r=="string"){const a=Lr(r);if(a&&typeof a=="object"){n(a.output_path??a.filled_path);const c=a.result,p=typeof c=="string"?Lr(c):c&&typeof c=="object"?c:null;p&&typeof p=="object"&&n(p.output_path??p.filled_path)}const l=r.match(/[A-Za-z]:[^\s"]+\.xlsx|\/[^\s"]+\.xlsx|[^\s"']+\.xlsx/);l&&l[0]&&n(l[0])}n(o.output_path??o.filled_path)}return t}function qf(e,t,n){return d`
  ...
  `}function Kf(e){return(e||"").trim().replace(/\\/g,"/").toLowerCase()}function Hf(e){var et,ee,Ie;const{basePath:t,workFilePaths:n,workOriginalFileNamesByPath:i,workRunning:o,workProgressStage:s,workRunStatus:r,workPendingChoices:a,workSelections:l,workResult:c,workError:p,workCustomerLevel:f,workDoRegisterOos:g,workPendingQuotationDraft:b,workQuotationDraftSaveStatus:$,workTextInput:k,workTextGenerating:S,workTextError:E,workPriceLevelOptions:I,onAddFile:N,onRemoveFile:R,onRenameFileName:A,onWorkTextChange:D,onGenerateFromText:y,onCustomerLevelChange:_,onDoRegisterOosChange:C,onRun:z,onCancel:P,onRetry:j,onSelectionChange:K,onResume:G,onQuotationLineChange:O,onQuotationDraftSave:ne,onQuotationDraftDismiss:be}=e,L=[u("work.stageExtract"),u("work.stageMatch"),u("work.stageFill")],Y=(()=>{switch(r){case"idle":return u("work.status.idle");case"running":return u("work.status.running");case"awaiting_choices":return u("work.status.awaitingChoices");case"resuming":return u("work.status.resuming");case"done":return u("work.status.done");case"error":default:return u("work.status.error")}})(),ge=U=>{const H=Rr(t,"/api/quotation/upload?with_summary=0"),te=new FormData;te.append("file",U),fetch(H,{method:"POST",body:te,credentials:"same-origin"}).then(ie=>ie.json()).then(ie=>{if((ie==null?void 0:ie.success)===!1)return;const we=ie.data??ie;typeof we.file_path=="string"&&N(we.file_path,we.file_name??U.name)}).catch(ie=>{console.warn("[work] upload failed",ie)})},Q=U=>{var ie;const H=U.target,te=(ie=H.files)==null?void 0:ie[0];te&&(ge(te),H.value="")},Ne=U=>{var te;U.preventDefault();const H=(te=U.dataTransfer)==null?void 0:te.files;if(!(!H||!H.length))for(let ie=0;ie<H.length;ie+=1){const we=H.item(ie);we&&ge(we)}},ae=U=>{U.preventDefault(),U.dataTransfer&&(U.dataTransfer.dropEffect="copy")};return d`
    <section class="card" style="margin-bottom: 16px;" aria-label=${u("tabs.work")}>
      ...
      >
        ...
        ${n.length?d`
              <ul style="margin-top: 8px; padding-left: 20px; font-size: 13px;">
                ${n.map((U,H)=>{const te=Kf(U),ie=U.split(/[/\\]/).pop()??U,we=te&&i[te]||ie;return d`
      ...
      <div style="display: flex; flex-wrap: wrap; gap: 16px; margin-bottom: 12px;">
        <div>
          ...
          ${(()=>{const U=I&&I.length>0?I:zf.map(H=>({value:H.value,label:u(H.labelKey)}));return d`<select
              .value=${f}
            ...
            >
              ${U.map(H=>d`<option value=${H.value}>${H.label}</option>`)}
            </select>`})()}
        </div>
                    ...
                    ${b.lines.map((U,H)=>d`
                        <tr>
                          ...
                          <td style="padding: 4px 8px; border: 1px solid var(--border);">
                            <input type="number" min="0" step="1" .value=${String(U.qty??"")} @change=${te=>O(H,"qty",te.target.value)} style="width: 72px;" aria-label=${u("work.lineQty")} />
                          </td>
                          <td style="padding: 4px 8px; border: 1px solid var(--border);">
                            <input type="text" .value=${U.code??""} @change=${te=>O(H,"code",te.target.value)} style="width: 90px;" aria-label=${u("work.lineCode")} />
                          </td>
                          <td style="padding: 4px 8px; border: 1px solid var(--border);">
                            <input type="text" .value=${U.quote_name??""} @change=${te=>O(H,"quote_name",te.target.value)} style="width: 120px;" aria-label=${u("work.lineQuoteName")} />
                          </td>
                          <td style="padding: 4px 8px; border: 1px solid var(--border);">${U.quote_spec??""}</td>
                          <td style="padding: 4px 8px; border: 1px solid var(--border);">
                            <input type="number" min="0" step="0.01" .value=${U.unit_price!=null?String(U.unit_price):""} @change=${te=>O(H,"unit_price",te.target.value)} style="width: 90px;" aria-label=${u("work.linePrice")} />
                          </td>
 ...
 */const Mr=(e,t,n)=>{const i=new Map;for(let o=t;o<=n;o++)i.set(e[o],o);return i},Ul=hs(class extends ms{constructor(e){if(super(e),e.type!==gs.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,n){let i;n===void 0?n=t:t!==void 0&&(i=t);const o=[],s=[];let r=0;for(const a of e)o[r]=i?i(a,r):r,s[r]=n(a,r),r++;return{values:s,keys:o}}render(e,t,n){return this.dt(e,t,n).values}update(e,[t,n,i]){const o=Xf(e),{values:s,keys:r}=this.dt(t,n,i);if(!Array.isArray(o))return this.ut=r,s;const a=this.ut??(this.ut=[]),l=[];let c,p,f=0,g=o.length-1,b=0,$=s.length-1;for(;f<=g&&b<=$;)if(o[f]===null)f++;else if(o[g]===null)g--;else if(a[f]===r[b])l[b]=gt(o[f],s[b]),f++,b++;else if(a[g]===r[$])l[$]=gt(o[g],s[$]),g--,$--;else if(a[f]===r[$])l[$]=gt(o[f],s[$]),Vt(e,l[$+1],o[f]),f++,$--;else if(a[g]===r[b])l[b]=gt(o[g],s[b]),Vt(e,o[f],o[g]),g--,b++;else if(c===void 0&&(c=Mr(r,b,$),p=Mr(a,f,g)),c.has(a[f]))if(c.has(a[g])){const k=p.get(r[b]),S=k!==void 0?o[k]:null;if(S===null){const E=Vt(e,o[f]);gt(E,s[b]),l[b]=E}else l[b]=gt(S,s[b]),Vt(e,o[f],S),o[k]=null;b++}else Xi(o[g]),g--;else Xi(o[f]),f++;for(;b<=$;){const k=Vt(e,l[$+1]);gt(k,s[b]),l[b++]=k}for(;f<=g;){const k=o[f++];k!==null&&Xi(k)}return this.ut=r,Vf(e,l),rt}}),pe={messageSquare:d`
    ...
    <div class="chat-controls">
      <label class="field chat-controls__session">
        <select
          ...
          @change=${c=>{const p=c.target.value;e.sessionKey=p,e.chatMessage="",e.chatStream=null,e.chatStreamStartedAt=null,e.chatRunId=null,e.resetToolStream(),e.resetChatScroll(),e.applySettings({...e.settings,sessionKey:p,lastActiveSessionKey:p}),e.loadAssistantIdentity(),kp(e,p),bn(e)}}
        >
  ...
  `}function jg(e){var O,ne,be,L,Y,ge,Q,Ne,ae,et,ee,Ie,U,H,te,ie;const{agent:t,configForm:n,agentFilesList:i,agentIdentity:o,agentIdentityLoading:s,agentIdentityError:r,configLoading:a,configSaving:l,configDirty:c,onConfigReload:p,onConfigSave:f,onModelChange:g,onModelFallbacksChange:b}=e,$=ki(n,t.id),S=(i&&i.agentId===t.id?i.workspace:null)||((O=$.entry)==null?void 0:O.workspace)||((ne=$.defaults)==null?void 0:ne.workspace)||"default",E=(be=$.entry)!=null&&be.model?cn((L=$.entry)==null?void 0:L.model):cn((Y=$.defaults)==null?void 0:Y.model),I=cn((ge=$.defaults)==null?void 0:ge.model),N=Ur((Q=$.entry)==null?void 0:Q.model)||(E!=="-"?Br(E):null),R=Ur((Ne=$.defaults)==null?void 0:Ne.model)||(I!=="-"?Br(I):null),A=N??R??null,D=wg((ae=$.entry)==null?void 0:ae.model),y=D?D.join(", "):"",_=((et=o==null?void 0:o.name)==null?void 0:et.trim())||((Ie=(ee=t.identity)==null?void 0:ee.name)==null?void 0:Ie.trim())||((U=t.name)==null?void 0:U.trim())||((H=$.entry)==null?void 0:H.name)||"-",z=xi(t,o)||"-",P=Array.isArray((te=$.entry)==null?void 0:te.skills)?(ie=$.entry)==null?void 0:ie.skills:null,j=(P==null?void 0:P.length)??null,K=s?"Loading…":r?"Unavailable":"",G=!!(e.defaultId&&t.id===e.defaultId);return d`
    <section class="card">
...
`:""}*No output — tool completed successfully.*`;t(b)}:void 0,a=o&&(((g=e.text)==null?void 0:g.length)??0)<=Pm,l=o&&!a,c=o&&a,p=!o;return d`
  ...
  `;Ai([pi({type:Number})],Kt.prototype,"splitRatio",2);Ai([pi({type:Number})],Kt.prototype,"minRatio",2);Ai([pi({type:Number})],Kt.prototype,"maxRatio",2);Kt=Ai([La("resizable-divider")],Kt);const Ym=5e3,Zm=/\.(xlsx|xls|xlsm|pdf)$/i;function ev(e){for(let t=0;t<e.length;t++)if(Zm.test(e[t].name))return e[t];return null}function ca(e){e.style.height="auto",e.style.height=`${e.scrollHeight}px`}function tv(e){return e?e.active?d`
...
\`\`\``)}})}
  ...
  `}const yv=new Set(["title","description","default","nullable"]);function bv(e){return Object.keys(e??{}).filter(n=>!yv.has(n)).length===0}function wc(e){const t=e.filter(o=>o!=null),n=t.length!==e.length,i=[];for(const o of t)i.some(s=>Object.is(s,o))||i.push(o);return{enumValues:i,nullable:n}}function wv(e){return!e||typeof e!="object"?{schema:null,unsupportedPaths:["<root>"]}:pn(e,[])}function pn(e,t){const n=new Set,i={...e},o=qo(t)||"<root>";if(e.anyOf||e.oneOf||e.allOf){const a=$v(e,t);return a||{schema:e,unsupportedPaths:[o]}}const s=Array.isArray(e.type)&&e.type.includes("null"),r=Te(e)??(e.properties||e.additionalProperties?"object":void 0);if(i.type=r??e.type,i.nullable=s||e.nullable,i.enum){const{enumValues:a,nullable:l}=wc(i.enum);i.enum=a,l&&(i.nullable=!0),a.length===0&&n.add(o)}if(r==="object"){const a=e.properties??{},l={};for(const[c,p]of Object.entries(a)){const f=pn(p,[...t,c]);f.schema&&(l[c]=f.schema);for(const g of f.unsupportedPaths)n.add(g)}if(i.properties=l,e.additionalProperties===!0)n.add(o);else if(e.additionalProperties===!1)i.additionalProperties=!1;else if(e.additionalProperties&&typeof e.additionalProperties=="object"&&!bv(e.additionalProperties)){const c=pn(e.additionalProperties,[...t,"*"]);i.additionalProperties=c.schema??e.additionalProperties,c.unsupportedPaths.length>0&&n.add(o)}}else if(r==="array"){const a=Array.isArray(e.items)?e.items[0]:e.items;if(!a)n.add(o);else{const l=pn(a,[...t,"*"]);i.items=l.schema??a,l.unsupportedPaths.length>0&&n.add(o)}}else r!=="string"&&r!=="number"&&r!=="integer"&&r!=="boolean"&&!i.enum&&n.add(o);return{schema:i,unsupportedPaths:Array.from(n)}}function $v(e,t){if(e.allOf)return null;const n=e.anyOf??e.oneOf;if(!n)return null;const i=[],o=[];let s=!1;for(const a of n){if(!a||typeof a!="object")return null;if(Array.isArray(a.enum)){const{enumValues:l,nullable:c}=wc(a.enum);i.push(...l),c&&(s=!0);continue}if("const"in a){if(a.const==null){s=!0;continue}i.push(a.const);continue}if(Te(a)==="null"){s=!0;continue}o.push(a)}if(i.length>0&&o.length===0){const a=[];for(const l of i)a.some(c=>Object.is(c,l))||a.push(l);return{schema:{...e,enum:a,nullable:s,anyOf:void 0,oneOf:void 0,allOf:void 0},unsupportedPaths:[]}}if(o.length===1){const a=pn(o[0],t);return a.schema&&(a.schema.nullable=s||a.schema.nullable),a}const r=new Set(["string","number","integer","boolean"]);return o.length>0&&i.length===0&&o.every(a=>a.type&&r.has(String(a.type)))?{schema:{...e,nullable:s},unsupportedPaths:[]}:null}const Fo={all:d`
...
${O.name??""}
${O.source??""}`.toLowerCase().includes(D)):i].sort((O,ne)=>Cv(O,ne,c,p)),C=_.length,z=Math.max(1,g||10),P=Math.max(1,Math.ceil(C/z)),j=Math.min(Math.max(1,f),P),K=(j-1)*z,G=_.slice(K,K+z);return d`
...
${L.specification??""}
${L.code??""}
${L.product_key??""}`.toLowerCase().includes(y)):D,C=[..._].sort((L,Y)=>Ev(L,Y,c,p)),z=C.length,P=Math.max(1,g||10),j=Math.max(1,Math.ceil(z/P)),K=Math.min(Math.max(1,f),j),G=(K-1)*P,O=C.slice(G,G+P),ne=_.filter(L=>o.includes(De(L))).length,be=_.length>0&&_.every(L=>o.includes(De(L)));return d`
  ...
  `}const xy=/^data:/i,ky=/^https?:\/\//i;function Sy(e){var a,l;const t=((a=e.agentsList)==null?void 0:a.agents)??[],n=Ba(e.sessionKey),i=(n==null?void 0:n.agentId)??((l=e.agentsList)==null?void 0:l.defaultId)??"main",o=t.find(c=>c.id===i),s=o==null?void 0:o.identity,r=(s==null?void 0:s.avatarUrl)??(s==null?void 0:s.avatar);if(r)return xy.test(r)||ky.test(r)?r:s==null?void 0:s.avatarUrl}function _y(e){var $,k,S,E,I,N,R,A,D;const t=e.presenceEntries.length,n=(($=e.sessionsResult)==null?void 0:$.count)??null,i=((k=e.cronStatus)==null?void 0:k.nextWakeAtMs)??null,o=e.connected?null:u("chat.disconnected"),s=e.tab==="chat",r=s&&(e.settings.chatFocusMode||e.onboarding),a=e.onboarding?!1:e.settings.chatShowThinking,l=Sy(e),c=e.chatAvatarUrl??l??null,p=e.configForm??((S=e.configSnapshot)==null?void 0:S.config),f=Ht(e.basePath??""),g=e.agentsSelectedId??((E=e.agentsList)==null?void 0:E.defaultId)??((R=(N=(I=e.agentsList)==null?void 0:I.agents)==null?void 0:N[0])==null?void 0:R.id)??null,b=xt.getLocale();return d`
    <div class="shell ${s?"shell--chat":""} ${r?"shell--chat-focus":""} ${e.settings.navCollapsed?"shell--nav-collapsed":""} ${e.onboarding?"shell--onboarding":""}">
      ...
      <aside class="nav ${e.settings.navCollapsed?"nav--collapsed":""}">
        ${sp.map(y=>{const _=e.settings.navGroupsCollapsed[y.label]??!1,C=y.tabs.some(z=>z===e.tab);return d`
      ...
      <main class="content ${s?"content--chat":""}">
        ...
        ${e.tab==="sessions"?Rv({basePath:e.basePath,loading:e.procurementLoading,error:e.procurementError,suggestions:e.procurementSuggestions,selectedKeys:e.procurementSelectedKeys,approvedKeys:e.procurementApprovedKeys,approveBusy:e.procurementApproveBusy,approveResult:e.procurementApproveResult,filterQuery:e.procurementFilterQuery,sortBy:e.procurementSortBy,sortDir:e.procurementSortDir,page:e.procurementPage,pageSize:e.procurementPageSize,replenishmentDrafts:e.replenishmentDrafts,replenishmentDetail:e.replenishmentDetail,replenishmentDetailId:e.replenishmentDetailId,replenishmentLoading:e.replenishmentLoading,replenishmentError:e.replenishmentError,replenishmentConfirmBusy:e.replenishmentConfirmBusy,replenishmentConfirmResult:e.replenishmentConfirmResult,replenishmentInputLines:e.replenishmentInputLines,replenishmentCreateBusy:e.replenishmentCreateBusy,onReplenishmentLineChange:(y,_,C)=>e.onReplenishmentLineChange(y,_,C),onReplenishmentAddLine:()=>e.onReplenishmentAddLine(),onReplenishmentRemoveLine:y=>e.onReplenishmentRemoveLine(y),onCreateReplenishmentDraft:()=>e.createProcurementReplenishmentDraft(),onReplenishmentRefresh:()=>e.loadProcurementReplenishment(),onSelectReplenishmentDraft:y=>{e.loadProcurementReplenishmentDetail(y)},onConfirmReplenishment:y=>{typeof window<"u"&&!window.confirm(u("replenishment.confirmPrompt"))||e.confirmProcurementReplenishment(y)},onDeleteReplenishmentDraft:y=>{typeof window<"u"&&!window.confirm(u("replenishment.deleteConfirm"))||e.deleteProcurementReplenishmentDraft(y)},onClearReplenishmentDetail:()=>{e.replenishmentDetail=null,e.replenishmentDetailId=null},onRefresh:()=>(e.procurementPage=1,e.loadProcurementSuggestions()),onToggleSelect:y=>{e.procurementSelectedKeys.includes(y)?e.procurementSelectedKeys=e.procurementSelectedKeys.filter(_=>_!==y):e.procurementSelectedKeys=[...e.procurementSelectedKeys,y]},onApprove:y=>{if(typeof window<"u"&&!window.confirm(u("procurement.approveConfirm")))return;const _=[{product_key:y.product_key,product_name:y.product_name,specification:y.specification,shortfall:y.shortfall,code:y.code}];ur(e,_).then(C=>{C&&(C.approved_count??0)>0&&(e.procurementApprovedKeys=[...e.procurementApprovedKeys,De(y)])})},onApproveBatch:()=>{const y=e.procurementSuggestions.filter(C=>e.procurementSelectedKeys.includes(De(C)));if(y.length===0||typeof window<"u"&&!window.confirm(u("procurement.approveBatchConfirm",{count:String(y.length)})))return;const _=y.map(C=>({product_key:C.product_key,product_name:C.product_name,specification:C.specification,shortfall:C.shortfall,code:C.code}));ur(e,_).then(C=>{if(C&&(C.approved_count??0)>0){const z=y.map(P=>De(P));e.procurementApprovedKeys=[...e.procurementApprovedKeys,...z],e.procurementSelectedKeys=e.procurementSelectedKeys.filter(P=>!z.includes(P))}})},onFilterQueryChange:y=>{e.procurementFilterQuery=y,e.procurementPage=1},onSortByChange:y=>{e.procurementSortBy=y,e.procurementPage=1},onSortDirChange:y=>{e.procurementSortDir=y,e.procurementPage=1},onPageChange:y=>{e.procurementPage=Math.max(1,y)},onPageSizeChange:y=>{e.procurementPageSize=Math.max(1,y),e.procurementPage=1}}):w}

        ${jf(e)}

        ${e.tab==="cron"?Tv({basePath:e.basePath,loading:e.fulfillDraftsLoading,error:e.fulfillDraftsError,drafts:e.fulfillDrafts,detail:e.fulfillDetail,detailId:e.fulfillDetailId,confirmBusy:e.fulfillConfirmBusy,confirmResult:e.fulfillConfirmResult,filterQuery:e.fulfillFilterQuery,sortBy:e.fulfillSortBy,sortDir:e.fulfillSortDir,page:e.fulfillPage,pageSize:e.fulfillPageSize,onRefresh:()=>(e.fulfillPage=1,e.loadFulfillDrafts()),onSelectDraft:y=>Yd(e,y),onConfirm:y=>{var j;const _=e.fulfillDetailId===y?e.fulfillDetail:null,C=((j=_==null?void 0:_.lines)==null?void 0:j.length)??0,z=((_==null?void 0:_.lines)??[]).reduce((K,G)=>K+Number(G.amount??0),0),P=C>0?u("fulfill.confirmPrompt",{count:String(C),amount:z.toFixed(2)}):u("fulfill.confirmPromptSimple");typeof window<"u"&&window.confirm(P)&&Zd(e,y).then(K=>{K!=null&&K.order_id&&e.loadProcurementSuggestions()})},onClearDetail:()=>{e.fulfillDetail=null,e.fulfillDetailId=null,e.fulfillConfirmResult=null},onFilterQueryChange:y=>{e.fulfillFilterQuery=y,e.fulfillPage=1},onSortByChange:y=>{e.fulfillSortBy=y,e.fulfillPage=1},onSortDirChange:y=>{e.fulfillSortDir=y,e.fulfillPage=1},onPageChange:y=>{e.fulfillPage=Math.max(1,y)},onPageSizeChange:y=>{e.fulfillPageSize=Math.max(1,y),e.fulfillPage=1}}):w}

        ${e.tab==="agents"?qg({loading:e.agentsLoading,error:e.agentsError,agentsList:e.agentsList,selectedAgentId:g,activePanel:e.agentsPanel,configForm:p,configLoading:e.configLoading,configSaving:e.configSaving,configDirty:e.configFormDirty,channelsLoading:e.channelsLoading,channelsError:e.channelsError,channelsSnapshot:e.channelsSnapshot,channelsLastSuccess:e.channelsLastSuccess,cronLoading:e.cronLoading,cronStatus:e.cronStatus,cronJobs:e.cronJobs,cronError:e.cronError,agentFilesLoading:e.agentFilesLoading,agentFilesError:e.agentFilesError,agentFilesList:e.agentFilesList,agentFileActive:e.agentFileActive,agentFileContents:e.agentFileContents,agentFileDrafts:e.agentFileDrafts,agentFileSaving:e.agentFileSaving,agentIdentityLoading:e.agentIdentityLoading,agentIdentityError:e.agentIdentityError,agentIdentityById:e.agentIdentityById,agentSkillsLoading:e.agentSkillsLoading,agentSkillsReport:e.agentSkillsReport,agentSkillsError:e.agentSkillsError,agentSkillsAgentId:e.agentSkillsAgentId,skillsFilter:e.skillsFilter,onRefresh:async()=>{var _,C;await Qo(e);const y=((C=(_=e.agentsList)==null?void 0:_.agents)==null?void 0:C.map(z=>z.id))??[];y.length>0&&qa(e,y)},onSelectAgent:y=>{e.agentsSelectedId!==y&&(e.agentsSelectedId=y,e.agentFilesList=null,e.agentFilesError=null,e.agentFilesLoading=!1,e.agentFileActive=null,e.agentFileContents={},e.agentFileDrafts={},e.agentSkillsReport=null,e.agentSkillsError=null,e.agentSkillsAgentId=null,za(e,y),e.agentsPanel==="files"&&Yi(e,y),e.agentsPanel==="skills"&&Vn(e,y))},onSelectPanel:y=>{var _;e.agentsPanel=y,y==="files"&&g&&((_=e.agentFilesList)==null?void 0:_.agentId)!==g&&(e.agentFilesList=null,e.agentFilesError=null,e.agentFileActive=null,e.agentFileContents={},e.agentFileDrafts={},Yi(e,g)),y==="skills"&&g&&Vn(e,g),y==="channels"&&Re(e,!1),y==="cron"&&e.loadCron()},onLoadFiles:y=>Yi(e,y),onSelectFile:y=>{e.agentFileActive=y,g&&dg(e,g,y)},onFileDraftChange:(y,_)=>{e.agentFileDrafts={...e.agentFileDrafts,[y]:_}},onFileReset:y=>{const _=e.agentFileContents[y]??"";e.agentFileDrafts={...e.agentFileDrafts,[y]:_}},onFileSave:y=>{if(!g)return;const _=e.agentFileDrafts[y]??e.agentFileContents[y]??"";ug(e,g,y,_)},onToolsProfileChange:(y,_,C)=>{var K;if(!p)return;const z=(K=p.agents)==null?void 0:K.list;if(!Array.isArray(z))return;const P=z.findIndex(G=>G&&typeof G=="object"&&"id"in G&&G.id===y);if(P<0)return;const j=["agents","list",P,"tools"];_?Ce(e,[...j,"profile"],_):Xe(e,[...j,"profile"]),C&&Xe(e,[...j,"allow"])},onToolsOverridesChange:(y,_,C)=>{var K;if(!p)return;const z=(K=p.agents)==null?void 0:K.list;if(!Array.isArray(z))return;const P=z.findIndex(G=>G&&typeof G=="object"&&"id"in G&&G.id===y);if(P<0)return;const j=["agents","list",P,"tools"];_.length>0?Ce(e,[...j,"alsoAllow"],_):Xe(e,[...j,"alsoAllow"]),C.length>0?Ce(e,[...j,"deny"],C):Xe(e,[...j,"deny"])},onConfigReload:()=>Ge(e),onConfigSave:()=>Qn(e),onChannelsRefresh:()=>Re(e,!1),onCronRefresh:()=>e.loadCron(),onSkillsFilterChange:y=>e.skillsFilter=y,onSkillsRefresh:()=>{g&&Vn(e,g)},onAgentSkillToggle:(y,_,C)=>{var L,Y,ge;if(!p)return;const z=(L=p.agents)==null?void 0:L.list;if(!Array.isArray(z))return;const P=z.findIndex(Q=>Q&&typeof Q=="object"&&"id"in Q&&Q.id===y);if(P<0)return;const j=z[P],K=_.trim();if(!K)return;const G=((ge=(Y=e.agentSkillsReport)==null?void 0:Y.skills)==null?void 0:ge.map(Q=>Q.name).filter(Boolean))??[],ne=(Array.isArray(j.skills)?j.skills.map(Q=>String(Q).trim()).filter(Boolean):void 0)??G,be=new Set(ne);C?be.add(K):be.delete(K),Ce(e,["agents","list",P,"skills"],[...be])},onAgentSkillsClear:y=>{var z;if(!p)return;const _=(z=p.agents)==null?void 0:z.list;if(!Array.isArray(_))return;const C=_.findIndex(P=>P&&typeof P=="object"&&"id"in P&&P.id===y);C<0||Xe(e,["agents","list",C,"skills"])},onAgentSkillsDisableAll:y=>{var z;if(!p)return;const _=(z=p.agents)==null?void 0:z.list;if(!Array.isArray(_))return;const C=_.findIndex(P=>P&&typeof P=="object"&&"id"in P&&P.id===y);C<0||Ce(e,["agents","list",C,"skills"],[])},onModelChange:(y,_)=>{var G;if(!p)return;const C=(G=p.agents)==null?void 0:G.list;if(!Array.isArray(C))return;const z=C.findIndex(O=>O&&typeof O=="object"&&"id"in O&&O.id===y);if(z<0)return;const P=["agents","list",z,"model"];if(!_){Xe(e,P);return}const j=C[z],K=j==null?void 0:j.model;if(K&&typeof K=="object"&&!Array.isArray(K)){const O=K.fallbacks,ne={primary:_,...Array.isArray(O)?{fallbacks:O}:{}};Ce(e,P,ne)}else Ce(e,P,_)},onModelFallbacksChange:(y,_)=>{var L;if(!p)return;const C=(L=p.agents)==null?void 0:L.list;if(!Array.isArray(C))return;const z=C.findIndex(Y=>Y&&typeof Y=="object"&&"id"in Y&&Y.id===y);if(z<0)return;const P=["agents","list",z,"model"],j=C[z],K=_.map(Y=>Y.trim()).filter(Boolean),G=j.model,ne=(()=>{if(typeof G=="string")return G.trim()||null;if(G&&typeof G=="object"&&!Array.isArray(G)){const Y=G.primary;if(typeof Y=="string")return Y.trim()||null}return null})();if(K.length===0){ne?Ce(e,P,ne):Xe(e,P);return}Ce(e,P,ne?{primary:ne,fallbacks:K}:{fallbacks:K})}}):w}
...
//# sourceMappingURL=index-2L7bvFpL.js.map
