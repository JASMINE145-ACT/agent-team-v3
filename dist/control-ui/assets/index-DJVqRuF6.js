...
`);l=g.pop()??"";for(const b of g){if(!b.startsWith("data: "))continue;const $=b.slice(6).trim();if(!$)continue;const k=ee(JSON.parse($),t,"stream_event"),S=ot(k.type,t,"stream_event.type");if(S==="stage"){const E=ve(k.stage)??Number(k.stage);if(!Number.isFinite(E))throw new ce(t,"stage must be a number");e.workProgressStage=E}else if(S==="result"){const E=xo(k.payload,t);ko(e,E),c=!0;break}}if(c)break}if(!c&&l.startsWith("data: ")){const p=l.slice(6).trim();if(p){const f=ee(JSON.parse(p),t,"stream_event_tail");if(f.type==="result"){const g=xo(f.payload,t);ko(e,g),c=!0}}}if(!c)throw new ce(t,"stream ended without result event")}catch(s){const r=Gt(e);throw r.cancelRequested?new Error("__WORK_CANCELLED__"):si(s)&&r.timeoutReached?new je("请求超时"):si(s)?new Error("请求已中断"):s instanceof ce||s instanceof je?s:s instanceof Error&&/network|failed to fetch|load failed/i.test(s.message)?new je(s.message):s}finally{o()}}function Rf(e,t){if(e===404||e===410)return!0;const n=ye(t,"").toLowerCase();return n.includes("run_id")||n.includes("run id")}async function Lf(e,t,n){const i="/api/work/resume",{signal:o,close:s}=Nl(e,wf);try{const r=await fetch(Sn(e.basePath,i),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({run_id:t,selections:n}),credentials:"same-origin",signal:o}),a=await r.json().catch(()=>({}));if(!r.ok){if(Rf(r.status,a))throw new $o(ye(a,"run_id 已失效"));const c=ye(a,`HTTP ${r.status}`);throw Fl(r.status)?new je(c):new Error(c)}const l=xo(a,i);ko(e,l)}catch(r){const a=Gt(e);throw a.cancelRequested?new Error("__WORK_CANCELLED__"):r instanceof $o?r:si(r)&&a.timeoutReached?new je("请求超时"):si(r)?new Error("请求已中断"):r instanceof ce||r instanceof je?r:r instanceof Error&&/network|failed to fetch|load failed/i.test(r.message)?new je(r.message):r}finally{s()}}function If(e){var n;const t=Gt(e);t.cancelRequested=!0,(n=t.controller)==null||n.abort("user_cancel"),fs(e),e.workRunning=!1}async function Ol(e){if(!e.workFilePaths.length){e.workError="请先上传至少一个报价单文件";return}const t=Gt(e);t.cancelRequested=!1,e.workRunning=!0,e.workError=null,e.workResult=null,e.workRunId=null,e.workPendingChoices=[],e.workSelections={},e.workPendingQuotationDraft=null,e.workQuotationDraftSaveStatus=null,oi(e,"running");let n=0;try{for(;;){n+=1;try{await Ef(e,"/api/work/run-stream");break}catch(i){if(i instanceof Error&&i.message==="__WORK_CANCELLED__"){fs(e);break}if(i instanceof je&&n<=Il){await Ml(Pl*n);continue}const o=i instanceof ce||i instanceof Error?i.message:String(i);Tf(e,o);break}}}finally{e.workRunning=!1}}async function Bl(e){const t=e.workRunId;if(!t||e.workPendingChoices.length===0){e.workError="缺少可继续的 run_id，请重新执行。",Ut(e,"error");return}const n=e.workPendingChoices.map(s=>({item_id:s.id,selected_code:e.workSelections[s.id]??"__OOS__"})),i=Gt(e);i.cancelRequested=!1,e.workRunning=!0,e.workError=null,oi(e,"resuming");let o=0;try{for(;;){o+=1;try{await Lf(e,t,n);break}catch(s){if(s instanceof Error&&s.message==="__WORK_CANCELLED__"){fs(e);break}if(s instanceof $o){ps(e),e.workResult={success:!1,error:s.message},e.workError=oe("继续流程",s.message,"当前待选项无法继续提交","请重新执行一次 Work 流程"),Ut(e,"error");break}if(s instanceof je&&o<=Il){await Ml(Pl*o);continue}const r=s instanceof ce||s instanceof Error?s.message:String(s);e.workResult={success:!1,error:r},e.workError=oe("继续流程",r,"本次续跑失败，尚未生成完整结果","点击“重试”继续，或重新执行 Work"),Ut(e,"error");break}}}finally{e.workRunning=!1}}async function Pf(e){if(e.workRunId&&e.workPendingChoices.length>0){await Bl(e);return}await Ol(e)}async function Df(e){const t=(e.workTextInput||"").trim();if(!t)return e.workTextError="请输入产品描述文字",!1;e.workTextGenerating=!0,e.workTextError=null;try{const n=await fetch(Sn(e.basePath,"/api/quotation/from-text"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:t}),credentials:"same-origin"}),i=await n.json().catch(()=>({}));if(!n.ok){let a=typeof i.detail=="string"?i.detail:ye(i,`HTTP ${n.status}`);return n.status===405&&(a="Method Not Allowed：该接口需 POST。请确认使用 python start.py 或 run_backend.py 启动前后端一体服务，且未通过仅支持 GET 的静态托管访问页面。"),e.workTextError=a,!1}const o=i&&typeof i.data=="object"?i.data:i,s=[],r={};if(Array.isArray(o.file_paths)){const a=Array.isArray(o.file_names)?o.file_names:[];o.file_paths.forEach((l,c)=>{if(typeof l!="string"||!l.trim())return;const p=l.trim();s.push(p);const f=typeof a[c]=="string"?a[c]:"";r[p]=f||p.split(/[/\\]/).pop()||p})}if(typeof o.file_path=="string"&&o.file_path.trim()){const a=o.file_path.trim();s.includes(a)||s.push(a);const l=typeof o.file_name=="string"?o.file_name:"";r[a]=l||a.split(/[/\\]/).pop()||a}if(!s.length)return e.workTextError="接口未返回 file_path/file_paths",!1;for(const a of s){e.workFilePaths.includes(a)||(e.workFilePaths=[...e.workFilePaths,a]);const l=Dl(a);if(l){const c=(r[a]||"").trim()||a.split(/[/\\]/).pop()||a;e.workOriginalFileNamesByPath={...e.workOriginalFileNamesByPath,[l]:c}}}return e.workTextError=null,!0}catch(n){const i=n instanceof Error?n.message:String(n);return e.workTextError=oe("从文字生成报价单",i,"未生成文件","请检查网络或后端后重试"),!1}finally{e.workTextGenerating=!1}}async function Mf(e){try{const t=Sn(e.basePath,"/api/config/price-levels"),n=await fetch(t);if(!n.ok)throw new Error(`HTTP ${n.status}`);const i=await n.json();i.success&&Array.isArray(i.data)&&(e.workPriceLevelOptions=i.data)}catch(t){console.warn("[work] 加载价格档位失败，使用本地默认值",t)}}async function Ff(e){var n;const t=e.workPendingQuotationDraft;if(!((n=t==null?void 0:t.lines)!=null&&n.length))return e.workQuotationDraftSaveStatus={status:"error",error:"无报价明细可保存"},!1;e.workQuotationDraftSaveStatus={status:"saving"};try{const i=await fetch(Sn(e.basePath,"/api/quotation-drafts"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:xf(e,t),source:t.source||"file",file_path:t.file_path??void 0,lines:t.lines.map(f=>({product_name:f.product_name??"",specification:f.specification??"",qty:Number(f.qty)||0,code:f.code??"",quote_name:f.quote_name??"",quote_spec:f.quote_spec??"",unit_price:f.unit_price!=null?Number(f.unit_price):null,amount:f.amount!=null?Number(f.amount):null,available_qty:Number(f.available_qty)||0,shortfall:Number(f.shortfall)||0,is_shortage:f.is_shortage?1:0,match_source:f.match_source??null}))}),credentials:"same-origin"}),o=await i.json().catch(()=>({}));if(!i.ok)return e.workQuotationDraftSaveStatus={status:"error",error:oe("保存报价单",ye(o,`HTTP ${i.status}`),"报价单仍停留在待保存状态","点击“重试”再次保存")},!1;const s=ee(o,"/api/quotation-drafts"),r=Xo(s.success),a=ee(s.data,"/api/quotation-drafts","data"),l=ot(a.draft_no,"/api/quotation-drafts","data.draft_no"),c=ve(a.draft_id)??Number(a.draft_id),p=Number.isFinite(c)?c:0;if(r===!1)throw new ce("/api/quotation-drafts","success is false");return e.workQuotationDraftSaveStatus={status:"ok",draft_no:l,draft_id:p},e.workPendingQuotationDraft=null,!0}catch(i){const o=i instanceof ce||i instanceof Error?i.message:String(i);return e.workQuotationDraftSaveStatus={status:"error",error:oe("保存报价单",o,"报价单仍停留在待保存状态","检查数据后重试")},!1}}function Nf(e){e.basePath=vp(),vf(e),Mf(e),gp(e),$p(e,!0),yp(e),bp(e),window.addEventListener("popstate",e.popStateHandler),Ll(e),Ud(e),e.tab==="logs"&&Ho(e),e.tab==="debug"&&Go(e)}function Of(e){Pd(e)}function Bf(e){var t;window.removeEventListener("popstate",e.popStateHandler),zd(e),jo(e),Wo(e),wp(e),(t=e.topbarObserver)==null||t.disconnect(),e.topbarObserver=null}function Uf(e,t){if(!(e.tab==="chat"&&e.chatManualRefreshInFlight)){if(e.tab==="chat"&&(t.has("chatMessages")||t.has("chatToolMessages")||t.has("chatStream")||t.has("chatLoading")||t.has("tab"))){const n=t.has("tab"),i=t.has("chatLoading")&&t.get("chatLoading")===!0&&!e.chatLoading;$n(e,n||i||!e.chatHasAutoScrolled)}e.tab==="logs"&&(t.has("logsEntries")||t.has("logsAutoFollow")||t.has("tab"))&&e.logsAutoFollow&&e.logsAtBottom&&Ua(e,t.has("tab")||t.has("logsAutoFollow"))}}const zf=[{value:"FACTORY_INC_TAX",labelKey:"work.priceLevels.FACTORY_INC_TAX"},{value:"FACTORY_EXC_TAX",labelKey:"work.priceLevels.FACTORY_EXC_TAX"},{value:"PURCHASE_EXC_TAX",labelKey:"work.priceLevels.PURCHASE_EXC_TAX"},{value:"A_MARGIN",labelKey:"work.priceLevels.A_MARGIN"},{value:"A_QUOTE",labelKey:"work.priceLevels.A_QUOTE"},{value:"B_MARGIN",labelKey:"work.priceLevels.B_MARGIN"},{value:"B_QUOTE",labelKey:"work.priceLevels.B_QUOTE"},{value:"C_MARGIN",labelKey:"work.priceLevels.C_MARGIN"},{value:"C_QUOTE",labelKey:"work.priceLevels.C_QUOTE"},{value:"D_MARGIN",labelKey:"work.priceLevels.D_MARGIN"},{value:"D_QUOTE",labelKey:"work.priceLevels.D_QUOTE"},{value:"D_LOW",labelKey:"work.priceLevels.D_LOW"},{value:"E_MARGIN",labelKey:"work.priceLevels.E_MARGIN"},{value:"E_QUOTE",labelKey:"work.priceLevels.E_QUOTE"}];function Rr(e,t){const n=e!=null&&e.trim()?e.trim().replace(/\/$/,""):"";return n?`${n}${t}`:t}function Lr(e){try{if(typeof e!="string"||!e.trim())return null;const t=e.trim();return t.startsWith("{")&&t.endsWith("}")||t.startsWith("[")&&t.endsWith("]")?JSON.parse(t):null}catch{return null}}function Ir(e){if(!Array.isArray(e))return[];const t=[],n=i=>{if(typeof i!="string"||!i.trim())return;const o=i.replace(/\\/g,"/").split("/").filter(Boolean).pop()??"";o&&!t.includes(o)&&t.push(o)};for(const i of e){const o=i,s=o.type,r=o.content;if(s==="observation"&&typeof r=="string"){const a=Lr(r);if(a&&typeof a=="object"){n(a.output_path??a.filled_path);const c=a.result,p=typeof c=="string"?Lr(c):c&&typeof c=="object"?c:null;p&&typeof p=="object"&&n(p.output_path??p.filled_path)}const l=r.match(/[A-Za-z]:[^\s"]+\.xlsx|\/[^\s"]+\.xlsx|[^\s"']+\.xlsx/);l&&l[0]&&n(l[0])}n(o.output_path??o.filled_path)}return t}function qf(e,t,n){return d`
  ...
  `}function Kf(e){return(e||"").trim().replace(/\\/g,"/").toLowerCase()}function Hf(e){var et,te,Ie;const{basePath:t,workFilePaths:n,workOriginalFileNamesByPath:i,workRunning:o,workProgressStage:s,workRunStatus:r,workPendingChoices:a,workSelections:l,workResult:c,workError:p,workCustomerLevel:f,workDoRegisterOos:g,workPendingQuotationDraft:b,workQuotationDraftSaveStatus:$,workTextInput:k,workTextGenerating:S,workTextError:E,workPriceLevelOptions:I,onAddFile:N,onRemoveFile:R,onRenameFileName:A,onWorkTextChange:D,onGenerateFromText:y,onCustomerLevelChange:_,onDoRegisterOosChange:C,onRun:q,onCancel:P,onRetry:j,onSelectionChange:H,onResume:G,onQuotationLineChange:O,onQuotationDraftSave:ne,onQuotationDraftDismiss:be}=e,L=[u("work.stageExtract"),u("work.stageMatch"),u("work.stageFill")],Y=(()=>{switch(r){case"idle":return u("work.status.idle");case"running":return u("work.status.running");case"awaiting_choices":return u("work.status.awaitingChoices");case"resuming":return u("work.status.resuming");case"done":return u("work.status.done");case"error":default:return u("work.status.error")}})(),ge=U=>{const K=Rr(t,"/api/quotation/upload?with_summary=0"),Z=new FormData;Z.append("file",U),fetch(K,{method:"POST",body:Z,credentials:"same-origin"}).then(ie=>ie.json()).then(ie=>{if((ie==null?void 0:ie.success)===!1)return;const we=ie.data??ie;typeof we.file_path=="string"&&N(we.file_path,we.file_name??U.name)}).catch(ie=>{console.warn("[work] upload failed",ie)})},Q=U=>{var ie;const K=U.target,Z=(ie=K.files)==null?void 0:ie[0];Z&&(ge(Z),K.value="")},Ne=U=>{var Z;U.preventDefault();const K=(Z=U.dataTransfer)==null?void 0:Z.files;if(!(!K||!K.length))for(let ie=0;ie<K.length;ie+=1){const we=K.item(ie);we&&ge(we)}},ae=U=>{U.preventDefault(),U.dataTransfer&&(U.dataTransfer.dropEffect="copy")};return d`
    <section class="card" style="margin-bottom: 16px;" aria-label=${u("tabs.work")}>
      ...
      >
        ...
        ${n.length?d`
              <ul style="margin-top: 8px; padding-left: 20px; font-size: 13px;">
                ${n.map((U,K)=>{const Z=Kf(U),ie=U.split(/[/\\]/).pop()??U,we=Z&&i[Z]||ie;return d`
                      <li style="display: flex; align-items: center; gap: 8px; margin-bottom: 4px;">
                        <input
                          type="text"
                          .value=${we}
                          @change=${Cn=>A(U,Cn.target.value)}
      ...
      <div style="margin-bottom: 12px; padding: 10px; border-radius: 8px; border: 1px solid var(--border); background: var(--bg-secondary, #fafafa);">
       ...
       ></textarea>
        <div style="display: flex; align-items: center; gap: 8px; margin-top: 8px; flex-wrap: wrap;">
          ...
          ${E?d`<span style="color: var(--danger, #c00); font-size: 13px;" role="alert">${E}</span>`:w}
        </div>
      </div>
      ...
      <div style="display: flex; flex-wrap: wrap; gap: 16px; margin-bottom: 12px;">
        <div>
          ...
          ${(()=>{const U=I&&I.length>0?I:zf.map(K=>({value:K.value,label:u(K.labelKey)}));return d`<select
              .value=${f}
            ...
            >
              ${U.map(K=>d`<option value=${K.value}>${K.label}</option>`)}
            </select>`})()}
        </div>
    ...
    ${r==="awaiting_choices"&&a.length?(()=>{const U=r;return d`
            <section class="card" style="margin-bottom: 16px;" aria-live="polite">
              ...
              <ul style="list-style: none; padding: 0; margin: 0;">
                ${a.map(K=>qf(K,l[K.id]??"__OOS__",Z=>H(K.id,Z)))}
              </ul>
              <div style="display: flex; gap: 8px; margin-top: 12px;">
                <button class="btn" style="background: var(--accent); color: var(--bg);" ?disabled=${o} @click=${G}>
                  ${u(o||U==="resuming"?"work.resuming":"work.resume")}
                </button>
                ${U==="error"?d`<button class="btn btn-sm" @click=${j}>${u("common.retry")}</button>`:w}
              </div>
            </section>
          `})():w}
                  ...
                  <tbody>
                    ${b.lines.map((U,K)=>d`
                        <tr>
                          ...
                          <td style="padding: 4px 8px; border: 1px solid var(--border);">${U.product_name??""}</td>
                          <td style="padding: 4px 8px; border: 1px solid var(--border);">${U.specification??""}</td>
                          <td style="padding: 4px 8px; border: 1px solid var(--border);">
                            <input type="number" min="0" step="1" .value=${String(U.qty??"")} @change=${Z=>O(K,"qty",Z.target.value)} style="width: 72px;" aria-label=${u("work.lineQty")} />
                          </td>
                          <td style="padding: 4px 8px; border: 1px solid var(--border);">
                            <input type="text" .value=${U.code??""} @change=${Z=>O(K,"code",Z.target.value)} style="width: 90px;" aria-label=${u("work.lineCode")} />
                          </td>
                          <td style="padding: 4px 8px; border: 1px solid var(--border);">
                            <input type="text" .value=${U.quote_name??""} @change=${Z=>O(K,"quote_name",Z.target.value)} style="width: 120px;" aria-label=${u("work.lineQuoteName")} />
                          </td>
                          <td style="padding: 4px 8px; border: 1px solid var(--border);">
                            <input type="text" .value=${U.quote_spec??""} @change=${Z=>O(K,"quote_spec",Z.target.value)} style="width: 120px;" aria-label=${u("work.lineQuoteSpec")} />
                          </td>
                          <td style="padding: 4px 8px; border: 1px solid var(--border);">
                            <input type="number" min="0" step="0.01" .value=${U.unit_price!=null?String(U.unit_price):""} @change=${Z=>O(K,"unit_price",Z.target.value)} style="width: 90px;" aria-label=${u("work.linePrice")} />
                          </td>
                          <td style="padding: 4px 8px; border: 1px solid var(--border);">${U.amount!=null?U.amount:""}</td>
                          <td style="padding: 4px 8px; border: 1px solid var(--border);">${U.available_qty??""}</td>
                          <td style="padding: 4px 8px; border: 1px solid var(--border);">${U.shortfall??""}</td>
                          <td style="padding: 4px 8px; border: 1px solid var(--border);">${U.is_shortage?u("common.yes"):u("common.no")}</td>
                        </tr>
                      `)}
                  </tbody>
                </table>
          ...
          <section class="card">
            ...
            ${Ir(c.trace).length?d`
                  <div style="margin-bottom: 12px;">
                    ${Ir(c.trace).map(U=>d`
                        <a href=${Rr(t,`/api/quotation/download?path=${encodeURIComponent(U)}`)} download=${U} class="btn btn-sm" style="margin-right: 8px; margin-bottom: 6px; text-decoration: none;">
                          ${u("work.download",{name:U})}
                        </a>
                      `)}
                  </div>
                `:w}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:Gf}=Xc,Pr=e=>e,Wf=e=>e.strings===void 0,Dr=()=>document.createComment(""),Xt=(e,t,n)=>{var s;const i=e._$AA.parentNode,o=t===void 0?e._$AB:t._$AA;if(n===void 0){const r=i.insertBefore(Dr(),o),a=i.insertBefore(Dr(),o);n=new Gf(r,a,e,e.options)}else{const r=n._$AB.nextSibling,a=n._$AM,l=a!==e;if(l){let c;(s=n._$AQ)==null||s.call(n,e),n._$AM=e,n._$AP!==void 0&&(c=e._$AU)!==a._$AU&&n._$AP(c)}if(r!==o||l){let c=n._$AA;for(;c!==r;){const p=Pr(c).nextSibling;Pr(i).insertBefore(c,o),c=p}}}return n},gt=(e,t,n=e)=>(e._$AI(t,n),e),Qf={},Vf=(e,t=Qf)=>e._$AH=t,Xf=e=>e._$AH,Xi=e=>{e._$AR(),e._$AA.remove()};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Mr=(e,t,n)=>{const i=new Map;for(let o=t;o<=n;o++)i.set(e[o],o);return i},Ul=hs(class extends ms{constructor(e){if(super(e),e.type!==gs.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,n){let i;n===void 0?n=t:t!==void 0&&(i=t);const o=[],s=[];let r=0;for(const a of e)o[r]=i?i(a,r):r,s[r]=n(a,r),r++;return{values:s,keys:o}}render(e,t,n){return this.dt(e,t,n).values}update(e,[t,n,i]){const o=Xf(e),{values:s,keys:r}=this.dt(t,n,i);if(!Array.isArray(o))return this.ut=r,s;const a=this.ut??(this.ut=[]),l=[];let c,p,f=0,g=o.length-1,b=0,$=s.length-1;for(;f<=g&&b<=$;)if(o[f]===null)f++;else if(o[g]===null)g--;else if(a[f]===r[b])l[b]=gt(o[f],s[b]),f++,b++;else if(a[g]===r[$])l[$]=gt(o[g],s[$]),g--,$--;else if(a[f]===r[$])l[$]=gt(o[f],s[$]),Xt(e,l[$+1],o[f]),f++,$--;else if(a[g]===r[b])l[b]=gt(o[g],s[b]),Xt(e,o[f],o[g]),g--,b++;else if(c===void 0&&(c=Mr(r,b,$),p=Mr(a,f,g)),c.has(a[f]))if(c.has(a[g])){const k=p.get(r[b]),S=k!==void 0?o[k]:null;if(S===null){const E=Xt(e,o[f]);gt(E,s[b]),l[b]=E}else l[b]=gt(S,s[b]),Xt(e,o[f],S),o[k]=null;b++}else Xi(o[g]),g--;else Xi(o[f]),f++;for(;b<=$;){const k=Xt(e,l[$+1]);gt(k,s[b]),l[b++]=k}for(;f<=g;){const k=o[f++];k!==null&&Xi(k)}return this.ut=r,Vf(e,l),rt}}),pe={messageSquare:d`
    ...
    <div class="chat-controls">
      <label class="field chat-controls__session">
        <select
          ...
          @change=${c=>{const p=c.target.value;e.sessionKey=p,e.chatMessage="",e.chatStream=null,e.chatStreamStartedAt=null,e.chatRunId=null,e.resetToolStream(),e.resetChatScroll(),e.applySettings({...e.settings,sessionKey:p,lastActiveSessionKey:p}),e.loadAssistantIdentity(),kp(e,p),Kt(e)}}
        >
  ...
  `}function Og(e){var E;const t=ki(e.configForm,e.agentId),n=((E=t.entry)==null?void 0:E.tools)??{},i=t.globalTools??{},o=n.profile??i.profile??"full",s=n.profile?"agent override":i.profile?"global default":"default",r=Array.isArray(n.allow)&&n.allow.length>0,a=Array.isArray(i.allow)&&i.allow.length>0,l=!!e.configForm&&!e.configLoading&&!e.configSaving&&!r,c=r?[]:Array.isArray(n.alsoAllow)?n.alsoAllow:[],p=r?[]:Array.isArray(n.deny)?n.deny:[],f=r?{allow:n.allow??[],deny:n.deny??[]}:Ag()??void 0,g=Nr.flatMap(I=>I.tools.map(N=>N.id)),b=I=>{const N=_g(I,f),R=zr(I,c),A=zr(I,p);return{allowed:(N||R)&&!A,baseAllowed:N,denied:A}},$=g.filter(I=>b(I).allowed).length,k=(I,N)=>{const R=new Set(c.map(_=>Ye(_)).filter(_=>_.length>0)),A=new Set(p.map(_=>Ye(_)).filter(_=>_.length>0)),D=b(I).baseAllowed,y=Ye(I);N?(A.delete(y),D||R.add(y)):(R.delete(y),A.add(y)),e.onOverridesChange(e.agentId,[...R],[...A])},S=I=>{const N=new Set(c.map(A=>Ye(A)).filter(A=>A.length>0)),R=new Set(p.map(A=>Ye(A)).filter(A=>A.length>0));for(const A of g){const D=b(A).baseAllowed,y=Ye(A);I?(R.delete(y),D||N.add(y)):(N.delete(y),R.add(y))}e.onOverridesChange(e.agentId,[...N],[...R])};return d`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
        ...
        ${Nr.map(I=>d`
              <div class="agent-tools-section">
                ...
                <div class="agent-tools-list">
                  ${I.tools.map(N=>{const{allowed:R}=b(N.id);return d`
  ...
  `}function Bg(e){var b,$,k;const t=!!e.configForm&&!e.configLoading&&!e.configSaving,n=ki(e.configForm,e.agentId),i=Array.isArray((b=n.entry)==null?void 0:b.skills)?($=n.entry)==null?void 0:$.skills:void 0,o=new Set((i??[]).map(S=>S.trim()).filter(Boolean)),s=i!==void 0,r=!!(e.report&&e.activeAgentId===e.agentId),a=r?((k=e.report)==null?void 0:k.skills)??[]:[],l=e.filter.trim().toLowerCase(),c=l?a.filter(S=>[S.name,S.description,S.source].join(" ").toLowerCase().includes(l)):a,p=jl(c),f=s?a.filter(S=>o.has(S.name)).length:a.length,g=a.length;return d`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
      ...
      ${c.length===0?d`
            ...
            `:d`
              <div class="agent-skills-groups" style="margin-top: 16px;">
                ${p.map(S=>Ug(S,{agentId:e.agentId,allowSet:o,usingAllowlist:s,editable:t,onToggle:e.onToggle}))}
              </div>
            `}
    </section>
    ...
    <div class="agents-layout">
      <section class="card agents-sidebar">
        ...
        <div class="agent-list" style="margin-top: 12px;">
          ${t.length===0?d`
                ...
                `:t.map(l=>{const c=Kl(l.id,n),p=xi(l,e.agentIdentityById[l.id]??null);return d`
                    <button
                      type="button"
      ...
      <section class="agents-main">
        ${o?d`
                ...
                ${e.activePanel==="tools"?Og({agentId:o.id,configForm:e.configForm,configLoading:e.configLoading,configSaving:e.configSaving,configDirty:e.configDirty,onProfileChange:e.onToolsProfileChange,onOverridesChange:e.onToolsOverridesChange,onConfigReload:e.onConfigReload,onConfigSave:e.onConfigSave}):w}
                ...
                ${e.activePanel==="channels"?Dg({context:Or(o,e.configForm,e.agentFilesList,n,e.agentIdentityById[o.id]??null),configForm:e.configForm,snapshot:e.channelsSnapshot,loading:e.channelsLoading,error:e.channelsError,lastSuccess:e.channelsLastSuccess,onRefresh:e.onChannelsRefresh}):w}
                ${e.activePanel==="cron"?Mg({context:Or(o,e.configForm,e.agentFilesList,n,e.agentIdentityById[o.id]??null),agentId:o.id,jobs:e.cronJobs,status:e.cronStatus,loading:e.cronLoading,error:e.cronError,onRefresh:e.onCronRefresh}):w}
              `:d`
                <div class="card">
  ...
  `}function jg(e){var O,ne,be,L,Y,ge,Q,Ne,ae,et,te,Ie,U,K,Z,ie;const{agent:t,configForm:n,agentFilesList:i,agentIdentity:o,agentIdentityLoading:s,agentIdentityError:r,configLoading:a,configSaving:l,configDirty:c,onConfigReload:p,onConfigSave:f,onModelChange:g,onModelFallbacksChange:b}=e,$=ki(n,t.id),S=(i&&i.agentId===t.id?i.workspace:null)||((O=$.entry)==null?void 0:O.workspace)||((ne=$.defaults)==null?void 0:ne.workspace)||"default",E=(be=$.entry)!=null&&be.model?dn((L=$.entry)==null?void 0:L.model):dn((Y=$.defaults)==null?void 0:Y.model),I=dn((ge=$.defaults)==null?void 0:ge.model),N=Ur((Q=$.entry)==null?void 0:Q.model)||(E!=="-"?Br(E):null),R=Ur((Ne=$.defaults)==null?void 0:Ne.model)||(I!=="-"?Br(I):null),A=N??R??null,D=wg((ae=$.entry)==null?void 0:ae.model),y=D?D.join(", "):"",_=((et=o==null?void 0:o.name)==null?void 0:et.trim())||((Ie=(te=t.identity)==null?void 0:te.name)==null?void 0:Ie.trim())||((U=t.name)==null?void 0:U.trim())||((K=$.entry)==null?void 0:K.name)||"-",q=xi(t,o)||"-",P=Array.isArray((Z=$.entry)==null?void 0:Z.skills)?(ie=$.entry)==null?void 0:ie.skills:null,j=(P==null?void 0:P.length)??null,H=s?"Loading…":r?"Unavailable":"",G=!!(e.defaultId&&t.id===e.defaultId);return d`
    <section class="card">
  ...
  `}function qr(e){var t;e&&((t=navigator.clipboard)==null||t.writeText(e).catch(()=>{}))}function Gg(e){const{loading:t,saving:n,error:i,content:o,lastSuccessAt:s,dependentFiles:r,onReload:a,onSave:l,onContentChange:c}=e,p=s!=null?new Date(s).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit",second:"2-digit"}):"";return d`
    <section class="card">
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const pn=(e,t)=>{var i;const n=e._$AN;if(n===void 0)return!1;for(const o of n)(i=o._$AO)==null||i.call(o,t,!1),pn(o,t);return!0},ri=e=>{let t,n;do{if((t=e._$AM)===void 0)break;n=t._$AN,n.delete(e),e=t}while((n==null?void 0:n.size)===0)},Vl=e=>{for(let t;t=e._$AM;e=t){let n=t._$AN;if(n===void 0)t._$AN=n=new Set;else if(n.has(e))break;n.add(e),Vg(t)}};function Wg(e){this._$AN!==void 0?(ri(this),this._$AM=e,Vl(this)):this._$AM=e}function Qg(e,t=!1,n=0){const i=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(t)if(Array.isArray(i))for(let s=n;s<i.length;s++)pn(i[s],!1),ri(i[s]);else i!=null&&(pn(i,!1),ri(i));else pn(this,e)}const Vg=e=>{e.type==gs.CHILD&&(e._$AP??(e._$AP=Qg),e._$AQ??(e._$AQ=Wg))};class Xg extends ms{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,n,i){super._$AT(t,n,i),Vl(this),this.isConnected=t._$AU}_$AO(t,n=!0){var i,o;t!==this.isConnected&&(this.isConnected=t,t?(i=this.reconnected)==null||i.call(this):(o=this.disconnected)==null||o.call(this)),n&&(pn(this,t),ri(this))}setValue(t){if(Wf(this._$Ct))this._$Ct._$AI(t,this);else{const n=[...this._$Ct._$AH];n[this._$Ci]=t,this._$Ct._$AI(n,this,0)}}disconnected(){}reconnected(){}}const Zi=new WeakMap,Jg=hs(class extends Xg{render(e){return w}update(e,[t]){var i;const n=t!==this.G;return n&&this.G!==void 0&&this.rt(void 0),(n||this.lt!==this.ct)&&(this.G=t,this.ht=(i=e.options)==null?void 0:i.host,this.rt(this.ct=e.element)),w}rt(e){if(this.isConnected||(e=void 0),typeof this.G=="function"){const t=this.ht??globalThis;let n=Zi.get(t);n===void 0&&(n=new WeakMap,Zi.set(t,n)),n.get(this.G)!==void 0&&this.G.call(this.ht,void 0),n.set(this.G,e),e!==void 0&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){var e,t;return typeof this.G=="function"?(e=Zi.get(this.ht??globalThis))==null?void 0:e.get(this.G):(t=this.G)==null?void 0:t.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ao extends ms{constructor(t){if(super(t),this.it=w,t.type!==gs.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===w||t==null)return this._t=void 0,this.it=t;if(t===rt)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const n=[t];return n.raw=n,this._t={_$litType$:this.constructor.resultType,strings:n,values:[]}}}Ao.directiveName="unsafeHTML",Ao.resultType=1;const Co=hs(Ao);/*! @license DOMPurify 3.3.1 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.3.1/LICENSE */const{entries:Xl,setPrototypeOf:Kr,isFrozen:Yg,getPrototypeOf:Zg,getOwnPropertyDescriptor:eh}=Object;let{freeze:ke,seal:Le,create:To}=Object,{apply:Eo,construct:Ro}=typeof Reflect<"u"&&Reflect;ke||(ke=function(t){return t});Le||(Le=function(t){return t});Eo||(Eo=function(t,n){for(var i=arguments.length,o=new Array(i>2?i-2:0),s=2;s<i;s++)o[s-2]=arguments[s];return t.apply(n,o)});Ro||(Ro=function(t){for(var n=arguments.length,i=new Array(n>1?n-1:0),o=1;o<n;o++)i[o-1]=arguments[o];return new t(...i)});const qn=Se(Array.prototype.forEach),th=Se(Array.prototype.lastIndexOf),Hr=Se(Array.prototype.pop),Jt=Se(Array.prototype.push),nh=Se(Array.prototype.splice),Yn=Se(String.prototype.toLowerCase),eo=Se(String.prototype.toString),to=Se(String.prototype.match),Yt=Se(String.prototype.replace),ih=Se(String.prototype.indexOf),oh=Se(String.prototype.trim),Pe=Se(Object.prototype.hasOwnProperty),$e=Se(RegExp.prototype.test),Zt=sh(TypeError);function Se(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var n=arguments.length,i=new Array(n>1?n-1:0),o=1;o<n;o++)i[o-1]=arguments[o];return Eo(e,t,i)}}function sh(e){return function(){for(var t=arguments.length,n=new Array(t),i=0;i<t;i++)n[i]=arguments[i];return Ro(e,n)}}function W(e,t){let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Yn;Kr&&Kr(e,null);let i=t.length;for(;i--;){let o=t[i];if(typeof o=="string"){const s=n(o);s!==o&&(Yg(t)||(t[i]=s),o=s)}e[o]=!0}return e}function rh(e){for(let t=0;t<e.length;t++)Pe(e,t)||(e[t]=null);return e}function ze(e){const t=To(null);for(const[n,i]of Xl(e))Pe(e,n)&&(Array.isArray(i)?t[n]=rh(i):i&&typeof i=="object"&&i.constructor===Object?t[n]=ze(i):t[n]=i);return t}function en(e,t){for(;e!==null;){const i=eh(e,t);if(i){if(i.get)return Se(i.get);if(typeof i.value=="function")return Se(i.value)}e=Zg(e)}function n(){return null}return n}const jr=ke(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),no=ke(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),io=ke(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),ah=ke(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),oo=ke(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),lh=ke(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Gr=ke(["#text"]),Wr=ke(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns","slot"]),so=ke(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Qr=ke(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Kn=ke(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),ch=Le(/\{\{[\w\W]*|[\w\W]*\}\}/gm),dh=Le(/<%[\w\W]*|[\w\W]*%>/gm),uh=Le(/\$\{[\w\W]*/gm),ph=Le(/^data-[\-\w.\u00B7-\uFFFF]+$/),fh=Le(/^aria-[\-\w]+$/),Jl=Le(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),gh=Le(/^(?:\w+script|data):/i),hh=Le(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Yl=Le(/^html$/i),mh=Le(/^[a-z][.\w]*(-[.\w]+)+$/i);var Vr=Object.freeze({__proto__:null,ARIA_ATTR:fh,ATTR_WHITESPACE:hh,CUSTOM_ELEMENT:mh,DATA_ATTR:ph,DOCTYPE_NAME:Yl,ERB_EXPR:dh,IS_ALLOWED_URI:Jl,IS_SCRIPT_OR_DATA:gh,MUSTACHE_EXPR:ch,TMPLIT_EXPR:uh});const tn={element:1,text:3,progressingInstruction:7,comment:8,document:9},vh=function(){return typeof window>"u"?null:window},yh=function(t,n){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let i=null;const o="data-tt-policy-suffix";n&&n.hasAttribute(o)&&(i=n.getAttribute(o));const s="dompurify"+(i?"#"+i:"");try{return t.createPolicy(s,{createHTML(r){return r},createScriptURL(r){return r}})}catch{return console.warn("TrustedTypes policy "+s+" could not be created."),null}},Xr=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function Zl(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:vh();const t=B=>Zl(B);if(t.version="3.3.1",t.removed=[],!e||!e.document||e.document.nodeType!==tn.document||!e.Element)return t.isSupported=!1,t;let{document:n}=e;const i=n,o=i.currentScript,{DocumentFragment:s,HTMLTemplateElement:r,Node:a,Element:l,NodeFilter:c,NamedNodeMap:p=e.NamedNodeMap||e.MozNamedAttrMap,HTMLFormElement:f,DOMParser:g,trustedTypes:b}=e,$=l.prototype,k=en($,"cloneNode"),S=en($,"remove"),E=en($,"nextSibling"),I=en($,"childNodes"),N=en($,"parentNode");if(typeof r=="function"){const B=n.createElement("template");B.content&&B.content.ownerDocument&&(n=B.content.ownerDocument)}let R,A="";const{implementation:D,createNodeIterator:y,createDocumentFragment:_,getElementsByTagName:C}=n,{importNode:q}=i;let P=Xr();t.isSupported=typeof Xl=="function"&&typeof N=="function"&&D&&D.createHTMLDocument!==void 0;const{MUSTACHE_EXPR:j,ERB_EXPR:H,TMPLIT_EXPR:G,DATA_ATTR:O,ARIA_ATTR:ne,IS_SCRIPT_OR_DATA:be,ATTR_WHITESPACE:L,CUSTOM_ELEMENT:Y}=Vr;let{IS_ALLOWED_URI:ge}=Vr,Q=null;const Ne=W({},[...jr,...no,...io,...oo,...Gr]);let ae=null;const et=W({},[...Wr,...so,...Qr,...Kn]);let te=Object.seal(To(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Ie=null,U=null;const K=Object.seal(To(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let Z=!0,ie=!0,we=!1,Cn=!0,Lt=!1,Tn=!0,ut=!1,Ci=!1,Ti=!1,It=!1,En=!1,Rn=!1,Es=!0,Rs=!1;const $c="user-content-";let Ei=!0,Wt=!1,Pt={},Oe=null;const Ri=W({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]);let Ls=null;const Is=W({},["audio","video","img","source","image","track"]);let Li=null;const Ps=W({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Ln="http://www.w3.org/1998/Math/MathML",In="http://www.w3.org/2000/svg",We="http://www.w3.org/1999/xhtml";let Dt=We,Ii=!1,Pi=null;const xc=W({},[Ln,In,We],eo);let Pn=W({},["mi","mo","mn","ms","mtext"]),Dn=W({},["annotation-xml"]);const kc=W({},["title","style","font","a","script"]);let Qt=null;const Sc=["application/xhtml+xml","text/html"],_c="text/html";let de=null,Mt=null;const Ac=n.createElement("form"),Ds=function(x){return x instanceof RegExp||x instanceof Function},Di=function(){let x=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(!(Mt&&Mt===x)){if((!x||typeof x!="object")&&(x={}),x=ze(x),Qt=Sc.indexOf(x.PARSER_MEDIA_TYPE)===-1?_c:x.PARSER_MEDIA_TYPE,de=Qt==="application/xhtml+xml"?eo:Yn,Q=Pe(x,"ALLOWED_TAGS")?W({},x.ALLOWED_TAGS,de):Ne,ae=Pe(x,"ALLOWED_ATTR")?W({},x.ALLOWED_ATTR,de):et,Pi=Pe(x,"ALLOWED_NAMESPACES")?W({},x.ALLOWED_NAMESPACES,eo):xc,Li=Pe(x,"ADD_URI_SAFE_ATTR")?W(ze(Ps),x.ADD_URI_SAFE_ATTR,de):Ps,Ls=Pe(x,"ADD_DATA_URI_TAGS")?W(ze(Is),x.ADD_DATA_URI_TAGS,de):Is,Oe=Pe(x,"FORBID_CONTENTS")?W({},x.FORBID_CONTENTS,de):Ri,Ie=Pe(x,"FORBID_TAGS")?W({},x.FORBID_TAGS,de):ze({}),U=Pe(x,"FORBID_ATTR")?W({},x.FORBID_ATTR,de):ze({}),Pt=Pe(x,"USE_PROFILES")?x.USE_PROFILES:!1,Z=x.ALLOW_ARIA_ATTR!==!1,ie=x.ALLOW_DATA_ATTR!==!1,we=x.ALLOW_UNKNOWN_PROTOCOLS||!1,Cn=x.ALLOW_SELF_CLOSE_IN_ATTR!==!1,Lt=x.SAFE_FOR_TEMPLATES||!1,Tn=x.SAFE_FOR_XML!==!1,ut=x.WHOLE_DOCUMENT||!1,It=x.RETURN_DOM||!1,En=x.RETURN_DOM_FRAGMENT||!1,Rn=x.RETURN_TRUSTED_TYPE||!1,Ti=x.FORCE_BODY||!1,Es=x.SANITIZE_DOM!==!1,Rs=x.SANITIZE_NAMED_PROPS||!1,Ei=x.KEEP_CONTENT!==!1,Wt=x.IN_PLACE||!1,ge=x.ALLOWED_URI_REGEXP||Jl,Dt=x.NAMESPACE||We,Pn=x.MATHML_TEXT_INTEGRATION_POINTS||Pn,Dn=x.HTML_INTEGRATION_POINTS||Dn,te=x.CUSTOM_ELEMENT_HANDLING||{},x.CUSTOM_ELEMENT_HANDLING&&Ds(x.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(te.tagNameCheck=x.CUSTOM_ELEMENT_HANDLING.tagNameCheck),x.CUSTOM_ELEMENT_HANDLING&&Ds(x.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(te.attributeNameCheck=x.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),x.CUSTOM_ELEMENT_HANDLING&&typeof x.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(te.allowCustomizedBuiltInElements=x.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),Lt&&(ie=!1),En&&(It=!0),Pt&&(Q=W({},Gr),ae=[],Pt.html===!0&&(W(Q,jr),W(ae,Wr)),Pt.svg===!0&&(W(Q,no),W(ae,so),W(ae,Kn)),Pt.svgFilters===!0&&(W(Q,io),W(ae,so),W(ae,Kn)),Pt.mathMl===!0&&(W(Q,oo),W(ae,Qr),W(ae,Kn))),x.ADD_TAGS&&(typeof x.ADD_TAGS=="function"?K.tagCheck=x.ADD_TAGS:(Q===Ne&&(Q=ze(Q)),W(Q,x.ADD_TAGS,de))),x.ADD_ATTR&&(typeof x.ADD_ATTR=="function"?K.attributeCheck=x.ADD_ATTR:(ae===et&&(ae=ze(ae)),W(ae,x.ADD_ATTR,de))),x.ADD_URI_SAFE_ATTR&&W(Li,x.ADD_URI_SAFE_ATTR,de),x.FORBID_CONTENTS&&(Oe===Ri&&(Oe=ze(Oe)),W(Oe,x.FORBID_CONTENTS,de)),x.ADD_FORBID_CONTENTS&&(Oe===Ri&&(Oe=ze(Oe)),W(Oe,x.ADD_FORBID_CONTENTS,de)),Ei&&(Q["#text"]=!0),ut&&W(Q,["html","head","body"]),Q.table&&(W(Q,["tbody"]),delete Ie.tbody),x.TRUSTED_TYPES_POLICY){if(typeof x.TRUSTED_TYPES_POLICY.createHTML!="function")throw Zt('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof x.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Zt('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');R=x.TRUSTED_TYPES_POLICY,A=R.createHTML("")}else R===void 0&&(R=yh(b,o)),R!==null&&typeof A=="string"&&(A=R.createHTML(""));ke&&ke(x),Mt=x}},Ms=W({},[...no,...io,...ah]),Fs=W({},[...oo,...lh]),Cc=function(x){let T=N(x);(!T||!T.tagName)&&(T={namespaceURI:Dt,tagName:"template"});const F=Yn(x.tagName),se=Yn(T.tagName);return Pi[x.namespaceURI]?x.namespaceURI===In?T.namespaceURI===We?F==="svg":T.namespaceURI===Ln?F==="svg"&&(se==="annotation-xml"||Pn[se]):!!Ms[F]:x.namespaceURI===Ln?T.namespaceURI===We?F==="math":T.namespaceURI===In?F==="math"&&Dn[se]:!!Fs[F]:x.namespaceURI===We?T.namespaceURI===In&&!Dn[se]||T.namespaceURI===Ln&&!Pn[se]?!1:!Fs[F]&&(kc[F]||!Ms[F]):!!(Qt==="application/xhtml+xml"&&Pi[x.namespaceURI]):!1},Be=function(x){Jt(t.removed,{element:x});try{N(x).removeChild(x)}catch{S(x)}},pt=function(x,T){try{Jt(t.removed,{attribute:T.getAttributeNode(x),from:T})}catch{Jt(t.removed,{attribute:null,from:T})}if(T.removeAttribute(x),x==="is")if(It||En)try{Be(T)}catch{}else try{T.setAttribute(x,"")}catch{}},Ns=function(x){let T=null,F=null;if(Ti)x="<remove></remove>"+x;else{const le=to(x,/^[\r\n\t ]+/);F=le&&le[0]}Qt==="application/xhtml+xml"&&Dt===We&&(x='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+x+"</body></html>");const se=R?R.createHTML(x):x;if(Dt===We)try{T=new g().parseFromString(se,Qt)}catch{}if(!T||!T.documentElement){T=D.createDocument(Dt,"template",null);try{T.documentElement.innerHTML=Ii?A:se}catch{}}const he=T.body||T.documentElement;return x&&F&&he.insertBefore(n.createTextNode(F),he.childNodes[0]||null),Dt===We?C.call(T,ut?"html":"body")[0]:ut?T.documentElement:he},Os=function(x){return y.call(x.ownerDocument||x,x,c.SHOW_ELEMENT|c.SHOW_COMMENT|c.SHOW_TEXT|c.SHOW_PROCESSING_INSTRUCTION|c.SHOW_CDATA_SECTION,null)},Mi=function(x){return x instanceof f&&(typeof x.nodeName!="string"||typeof x.textContent!="string"||typeof x.removeChild!="function"||!(x.attributes instanceof p)||typeof x.removeAttribute!="function"||typeof x.setAttribute!="function"||typeof x.namespaceURI!="string"||typeof x.insertBefore!="function"||typeof x.hasChildNodes!="function")},Bs=function(x){return typeof a=="function"&&x instanceof a};function Qe(B,x,T){qn(B,F=>{F.call(t,x,T,Mt)})}const Us=function(x){let T=null;if(Qe(P.beforeSanitizeElements,x,null),Mi(x))return Be(x),!0;const F=de(x.nodeName);if(Qe(P.uponSanitizeElement,x,{tagName:F,allowedTags:Q}),Tn&&x.hasChildNodes()&&!Bs(x.firstElementChild)&&$e(/<[/\w!]/g,x.innerHTML)&&$e(/<[/\w!]/g,x.textContent)||x.nodeType===tn.progressingInstruction||Tn&&x.nodeType===tn.comment&&$e(/<[/\w]/g,x.data))return Be(x),!0;if(!(K.tagCheck instanceof Function&&K.tagCheck(F))&&(!Q[F]||Ie[F])){if(!Ie[F]&&qs(F)&&(te.tagNameCheck instanceof RegExp&&$e(te.tagNameCheck,F)||te.tagNameCheck instanceof Function&&te.tagNameCheck(F)))return!1;if(Ei&&!Oe[F]){const se=N(x)||x.parentNode,he=I(x)||x.childNodes;if(he&&se){const le=he.length;for(let _e=le-1;_e>=0;--_e){const Ve=k(he[_e],!0);Ve.__removalCount=(x.__removalCount||0)+1,se.insertBefore(Ve,E(x))}}}return Be(x),!0}return x instanceof l&&!Cc(x)||(F==="noscript"||F==="noembed"||F==="noframes")&&$e(/<\/no(script|embed|frames)/i,x.innerHTML)?(Be(x),!0):(Lt&&x.nodeType===tn.text&&(T=x.textContent,qn([j,H,G],se=>{T=Yt(T,se," ")}),x.textContent!==T&&(Jt(t.removed,{element:x.cloneNode()}),x.textContent=T)),Qe(P.afterSanitizeElements,x,null),!1)},zs=function(x,T,F){if(Es&&(T==="id"||T==="name")&&(F in n||F in Ac))return!1;if(!(ie&&!U[T]&&$e(O,T))){if(!(Z&&$e(ne,T))){if(!(K.attributeCheck instanceof Function&&K.attributeCheck(T,x))){if(!ae[T]||U[T]){if(!(qs(x)&&(te.tagNameCheck instanceof RegExp&&$e(te.tagNameCheck,x)||te.tagNameCheck instanceof Function&&te.tagNameCheck(x))&&(te.attributeNameCheck instanceof RegExp&&$e(te.attributeNameCheck,T)||te.attributeNameCheck instanceof Function&&te.attributeNameCheck(T,x))||T==="is"&&te.allowCustomizedBuiltInElements&&(te.tagNameCheck instanceof RegExp&&$e(te.tagNameCheck,F)||te.tagNameCheck instanceof Function&&te.tagNameCheck(F))))return!1}else if(!Li[T]){if(!$e(ge,Yt(F,L,""))){if(!((T==="src"||T==="xlink:href"||T==="href")&&x!=="script"&&ih(F,"data:")===0&&Ls[x])){if(!(we&&!$e(be,Yt(F,L,"")))){if(F)return!1}}}}}}}return!0},qs=function(x){return x!=="annotation-xml"&&to(x,Y)},Ks=function(x){Qe(P.beforeSanitizeAttributes,x,null);const{attributes:T}=x;if(!T||Mi(x))return;const F={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:ae,forceKeepAttr:void 0};let se=T.length;for(;se--;){const he=T[se],{name:le,namespaceURI:_e,value:Ve}=he,Ft=de(le),Fi=Ve;let fe=le==="value"?Fi:oh(Fi);if(F.attrName=Ft,F.attrValue=fe,F.keepAttr=!0,F.forceKeepAttr=void 0,Qe(P.uponSanitizeAttribute,x,F),fe=F.attrValue,Rs&&(Ft==="id"||Ft==="name")&&(pt(le,x),fe=$c+fe),Tn&&$e(/((--!?|])>)|<\/(style|title|textarea)/i,fe)){pt(le,x);continue}if(Ft==="attributename"&&to(fe,"href")){pt(le,x);continue}if(F.forceKeepAttr)continue;if(!F.keepAttr){pt(le,x);continue}if(!Cn&&$e(/\/>/i,fe)){pt(le,x);continue}Lt&&qn([j,H,G],js=>{fe=Yt(fe,js," ")});const Hs=de(x.nodeName);if(!zs(Hs,Ft,fe)){pt(le,x);continue}if(R&&typeof b=="object"&&typeof b.getAttributeType=="function"&&!_e)switch(b.getAttributeType(Hs,Ft)){case"TrustedHTML":{fe=R.createHTML(fe);break}case"TrustedScriptURL":{fe=R.createScriptURL(fe);break}}if(fe!==Fi)try{_e?x.setAttributeNS(_e,le,fe):x.setAttribute(le,fe),Mi(x)?Be(x):Hr(t.removed)}catch{pt(le,x)}}Qe(P.afterSanitizeAttributes,x,null)},Tc=function B(x){let T=null;const F=Os(x);for(Qe(P.beforeSanitizeShadowDOM,x,null);T=F.nextNode();)Qe(P.uponSanitizeShadowNode,T,null),Us(T),Ks(T),T.content instanceof s&&B(T.content);Qe(P.afterSanitizeShadowDOM,x,null)};return t.sanitize=function(B){let x=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},T=null,F=null,se=null,he=null;if(Ii=!B,Ii&&(B="<!-->"),typeof B!="string"&&!Bs(B))if(typeof B.toString=="function"){if(B=B.toString(),typeof B!="string")throw Zt("dirty is not a string, aborting")}else throw Zt("toString is not a function");if(!t.isSupported)return B;if(Ci||Di(x),t.removed=[],typeof B=="string"&&(Wt=!1),Wt){if(B.nodeName){const Ve=de(B.nodeName);if(!Q[Ve]||Ie[Ve])throw Zt("root node is forbidden and cannot be sanitized in-place")}}else if(B instanceof a)T=Ns("<!---->"),F=T.ownerDocument.importNode(B,!0),F.nodeType===tn.element&&F.nodeName==="BODY"||F.nodeName==="HTML"?T=F:T.appendChild(F);else{if(!It&&!Lt&&!ut&&B.indexOf("<")===-1)return R&&Rn?R.createHTML(B):B;if(T=Ns(B),!T)return It?null:Rn?A:""}T&&Ti&&Be(T.firstChild);const le=Os(Wt?B:T);for(;se=le.nextNode();)Us(se),Ks(se),se.content instanceof s&&Tc(se.content);if(Wt)return B;if(It){if(En)for(he=_.call(T.ownerDocument);T.firstChild;)he.appendChild(T.firstChild);else he=T;return(ae.shadowroot||ae.shadowrootmode)&&(he=q.call(i,he,!0)),he}let _e=ut?T.outerHTML:T.innerHTML;return ut&&Q["!doctype"]&&T.ownerDocument&&T.ownerDocument.doctype&&T.ownerDocument.doctype.name&&$e(Yl,T.ownerDocument.doctype.name)&&(_e="<!DOCTYPE "+T.ownerDocument.doctype.name+`>
`+_e),Lt&&qn([j,H,G],Ve=>{_e=Yt(_e,Ve," ")}),R&&Rn?R.createHTML(_e):_e},t.setConfig=function(){let B=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Di(B),Ci=!0},t.clearConfig=function(){Mt=null,Ci=!1},t.isValidAttribute=function(B,x,T){Mt||Di({});const F=de(B),se=de(x);return zs(F,se,T)},t.addHook=function(B,x){typeof x=="function"&&Jt(P[B],x)},t.removeHook=function(B,x){if(x!==void 0){const T=th(P[B],x);return T===-1?void 0:nh(P[B],T,1)[0]}return Hr(P[B])},t.removeHooks=function(B){P[B]=[]},t.removeAllHooks=function(){P=Xr()},t}var Lo=Zl();function vs(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Rt=vs();function ec(e){Rt=e}var vt={exec:()=>null};function X(e,t=""){let n=typeof e=="string"?e:e.source,i={replace:(o,s)=>{let r=typeof s=="string"?s:s.source;return r=r.replace(xe.caret,"$1"),n=n.replace(o,r),i},getRegex:()=>new RegExp(n,t)};return i}var bh=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),xe={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}>`)},wh=/^(?:[ \t]*(?:\n|$))+/,$h=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,xh=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,An=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,kh=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,ys=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,tc=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,nc=X(tc).replace(/bull/g,ys).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Sh=X(tc).replace(/bull/g,ys).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),bs=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,_h=/^[^\n]+/,ws=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Ah=X(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",ws).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Ch=X(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,ys).getRegex(),Si="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",$s=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Th=X("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",$s).replace("tag",Si).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),ic=X(bs).replace("hr",An).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Si).getRegex(),Eh=X(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",ic).getRegex(),xs={blockquote:Eh,code:$h,def:Ah,fences:xh,heading:kh,hr:An,html:Th,lheading:nc,list:Ch,newline:wh,paragraph:ic,table:vt,text:_h},Jr=X("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",An).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Si).getRegex(),Rh={...xs,lheading:Sh,table:Jr,paragraph:X(bs).replace("hr",An).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Jr).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Si).getRegex()},Lh={...xs,html:X(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",$s).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:vt,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:X(bs).replace("hr",An).replace("heading",` *#{1,6} *[^
]`).replace("lheading",nc).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Ih=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Ph=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,oc=/^( {2,}|\\)\n(?!\s*$)/,Dh=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,_i=/[\p{P}\p{S}]/u,ks=/[\s\p{P}\p{S}]/u,sc=/[^\s\p{P}\p{S}]/u,Mh=X(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,ks).getRegex(),rc=/(?!~)[\p{P}\p{S}]/u,Fh=/(?!~)[\s\p{P}\p{S}]/u,Nh=/(?:[^\s\p{P}\p{S}]|~)/u,ac=/(?![*_])[\p{P}\p{S}]/u,Oh=/(?![*_])[\s\p{P}\p{S}]/u,Bh=/(?:[^\s\p{P}\p{S}]|[*_])/u,Uh=X(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",bh?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),lc=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,zh=X(lc,"u").replace(/punct/g,_i).getRegex(),qh=X(lc,"u").replace(/punct/g,rc).getRegex(),cc="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Kh=X(cc,"gu").replace(/notPunctSpace/g,sc).replace(/punctSpace/g,ks).replace(/punct/g,_i).getRegex(),Hh=X(cc,"gu").replace(/notPunctSpace/g,Nh).replace(/punctSpace/g,Fh).replace(/punct/g,rc).getRegex(),jh=X("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,sc).replace(/punctSpace/g,ks).replace(/punct/g,_i).getRegex(),Gh=X(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,ac).getRegex(),Wh="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",Qh=X(Wh,"gu").replace(/notPunctSpace/g,Bh).replace(/punctSpace/g,Oh).replace(/punct/g,ac).getRegex(),Vh=X(/\\(punct)/,"gu").replace(/punct/g,_i).getRegex(),Xh=X(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Jh=X($s).replace("(?:-->|$)","-->").getRegex(),Yh=X("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Jh).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),ai=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,Zh=X(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",ai).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),dc=X(/^!?\[(label)\]\[(ref)\]/).replace("label",ai).replace("ref",ws).getRegex(),uc=X(/^!?\[(ref)\](?:\[\])?/).replace("ref",ws).getRegex(),em=X("reflink|nolink(?!\\()","g").replace("reflink",dc).replace("nolink",uc).getRegex(),Yr=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Ss={_backpedal:vt,anyPunctuation:Vh,autolink:Xh,blockSkip:Uh,br:oc,code:Ph,del:vt,delLDelim:vt,delRDelim:vt,emStrongLDelim:zh,emStrongRDelimAst:Kh,emStrongRDelimUnd:jh,escape:Ih,link:Zh,nolink:uc,punctuation:Mh,reflink:dc,reflinkSearch:em,tag:Yh,text:Dh,url:vt},tm={...Ss,link:X(/^!?\[(label)\]\((.*?)\)/).replace("label",ai).getRegex(),reflink:X(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",ai).getRegex()},Io={...Ss,emStrongRDelimAst:Hh,emStrongLDelim:qh,delLDelim:Gh,delRDelim:Qh,url:X(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Yr).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:X(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Yr).getRegex()},nm={...Io,br:X(oc).replace("{2,}","*").getRegex(),text:X(Io.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Hn={normal:xs,gfm:Rh,pedantic:Lh},nn={normal:Ss,gfm:Io,breaks:nm,pedantic:tm},im={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Zr=e=>im[e];function qe(e,t){if(t){if(xe.escapeTest.test(e))return e.replace(xe.escapeReplace,Zr)}else if(xe.escapeTestNoEncode.test(e))return e.replace(xe.escapeReplaceNoEncode,Zr);return e}function ea(e){try{e=encodeURI(e).replace(xe.percentDecode,"%")}catch{return null}return e}function ta(e,t){var s;let n=e.replace(xe.findPipe,(r,a,l)=>{let c=!1,p=a;for(;--p>=0&&l[p]==="\\";)c=!c;return c?"|":" |"}),i=n.split(xe.splitPipe),o=0;if(i[0].trim()||i.shift(),i.length>0&&!((s=i.at(-1))!=null&&s.trim())&&i.pop(),t)if(i.length>t)i.splice(t);else for(;i.length<t;)i.push("");for(;o<i.length;o++)i[o]=i[o].trim().replace(xe.slashPipe,"|");return i}function on(e,t,n){let i=e.length;if(i===0)return"";let o=0;for(;o<i&&e.charAt(i-o-1)===t;)o++;return e.slice(0,i-o)}function om(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let i=0;i<e.length;i++)if(e[i]==="\\")i++;else if(e[i]===t[0])n++;else if(e[i]===t[1]&&(n--,n<0))return i;return n>0?-2:-1}function sm(e,t=0){let n=t,i="";for(let o of e)if(o==="	"){let s=4-n%4;i+=" ".repeat(s),n+=s}else i+=o,n++;return i}function na(e,t,n,i,o){let s=t.href,r=t.title||null,a=e[1].replace(o.other.outputLinkReplace,"$1");i.state.inLink=!0;let l={type:e[0].charAt(0)==="!"?"image":"link",raw:n,href:s,title:r,text:a,tokens:i.inlineTokens(a)};return i.state.inLink=!1,l}function rm(e,t,n){let i=e.match(n.other.indentCodeCompensation);if(i===null)return t;let o=i[1];return t.split(`
...
`,e=e.substring($.length+1),p=!0),!p){let E=this.rules.other.nextBulletRegex(S),I=this.rules.other.hrRegex(S),N=this.rules.other.fencesBeginRegex(S),R=this.rules.other.headingBeginRegex(S),A=this.rules.other.htmlBeginRegex(S),D=this.rules.other.blockquoteBeginRegex(S);for(;e;){let y=e.split(`
`,1)[0],_;if($=y,this.options.pedantic?($=$.replace(this.rules.other.listReplaceNesting,"  "),_=$):_=$.replace(this.rules.other.tabCharGlobal,"    "),N.test($)||R.test($)||A.test($)||D.test($)||E.test($)||I.test($))break;if(_.search(this.rules.other.nonSpaceChar)>=S||!$.trim())g+=`
`+_.slice(S);else{if(k||b.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||N.test(b)||R.test(b)||I.test(b))break;g+=`
`+$}k=!$.trim(),f+=y+`
...
`:""}*No output — tool completed successfully.*`;t(b)}:void 0,a=o&&(((g=e.text)==null?void 0:g.length)??0)<=Pm,l=o&&!a,c=o&&a,p=!o;return d`
    ...
    >
      ...
      ${p?d`
            ...
            `:w}
      ${l?d`<div class="chat-tool-card__preview mono">${Fm(e.text)}</div>`:w}
      ${c?d`<div class="chat-tool-card__inline mono">${e.text}</div>`:w}
    </div>
  `}function Om(e){return Array.isArray(e)?e.filter(Boolean):[]}function Bm(e){if(typeof e!="string")return e;const t=e.trim();if(!t||!t.startsWith("{")&&!t.startsWith("["))return e;try{return JSON.parse(t)}catch{return e}}function Um(e){if(typeof e.text=="string")return e.text;if(typeof e.content=="string")return e.content}function zm(e){const n=e.content,i=[];if(!Array.isArray(n))return i;for(const o of n){if(typeof o!="object"||o===null)continue;const s=o;if(s.type!=="file"||typeof s.file_name!="string")continue;const r=s.summaryMeta;i.push({file_name:s.file_name,file_path:typeof s.file_path=="string"?s.file_path:void 0,rows_count:r==null?void 0:r.rows_count,preview_count:r==null?void 0:r.preview_count,truncated:r==null?void 0:r.truncated})}return i}function qm(e){const n=e.content,i=[];if(Array.isArray(n))for(const o of n){if(typeof o!="object"||o===null)continue;const s=o;if(s.type==="image"){const r=s.source;if((r==null?void 0:r.type)==="base64"&&typeof r.data=="string"){const a=r.data,l=r.media_type||"image/png",c=a.startsWith("data:")?a:`data:${l};base64,${a}`;i.push({url:c})}else typeof s.url=="string"&&i.push({url:s.url})}else if(s.type==="image_url"){const r=s.image_url;typeof(r==null?void 0:r.url)=="string"&&i.push({url:r.url})}}return i}function Km(e){return d`
  ...
  `}function Hm(e,t,n,i){const o=new Date(t).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"}),s=(i==null?void 0:i.name)??"Assistant";return d`
    <div class="chat-group assistant">
      ${Cs("assistant",i)}
      <div class="chat-group-messages">
  ...
  `}function jm(e,t){const n=As(e.role),i=t.assistantName??"Assistant",o=n==="user"?"You":n==="assistant"?i:n,s=n==="user"?"user":n==="assistant"?"assistant":"other",r=new Date(e.timestamp).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"});return d`
  ...
  `}function Cs(e,t){var a,l;const n=As(e),i=((a=t==null?void 0:t.name)==null?void 0:a.trim())||"Assistant",o=((l=t==null?void 0:t.avatar)==null?void 0:l.trim())||"",s=n==="user"?"U":n==="assistant"?i.charAt(0).toUpperCase()||"A":n==="tool"?"⚙":"?",r=n==="user"?"user":n==="assistant"?"assistant":n==="tool"?"tool":"other";return o&&n==="assistant"?Gm(o)?d`<img
        class="chat-avatar ${r}"
        src="${o}"
        alt="${i}"
      />`:d`<div class="chat-avatar ${r}">${o}</div>`:d`<div class="chat-avatar ${r}">${s}</div>`}function Gm(e){return/^https?:\/\//i.test(e)||/^data:image\//i.test(e)||e.startsWith("/")}function Wm(e){return e.length===0?w:d`
  ...
  `}function Qm(e){return e.length===0?w:d`
  ...
  `}function bc(e,t,n){const i=e,o=typeof i.role=="string"?i.role:"unknown",s=vc(e)||o.toLowerCase()==="toolresult"||o.toLowerCase()==="tool_result"||typeof i.toolCallId=="string"||typeof i.tool_call_id=="string",r=Nm(e),a=r.length>0,l=qm(e),c=l.length>0,p=zm(e),f=p.length>0,g=xl(e),b=t.showReasoning&&o==="assistant"?Fp(e):null,$=g!=null&&g.trim()?g:null,k=b?Op(b):null,S=$,E=o==="assistant"&&!!(S!=null&&S.trim()),I=["chat-bubble",E?"has-copy":"",t.isStreaming?"streaming":"","fade-in"].filter(Boolean).join(" ");return!S&&a&&s?d`${r.map(N=>la(N,n))}`:!S&&!a&&!c&&!f?w:d`
    <div class="${I}">
      ${E?xm(S):w}
      ${Wm(l)}
      ${Qm(p)}
      ${k?d`<div class="chat-thinking">${Co(Mo(k))}</div>`:w}
      ${S?d`<div class="chat-text" dir="${gc(S)}">${Co(Mo(S))}</div>`:w}
      ${r.map(N=>la(N,n))}
    </div>
  `}function Vm(e){return d`
  ...
  `;Ai([pi({type:Number})],Ht.prototype,"splitRatio",2);Ai([pi({type:Number})],Ht.prototype,"minRatio",2);Ai([pi({type:Number})],Ht.prototype,"maxRatio",2);Ht=Ai([La("resizable-divider")],Ht);const Ym=5e3,Zm=/\.(xlsx|xls|xlsm|pdf)$/i;function ev(e){for(let t=0;t<e.length;t++)if(Zm.test(e[t].name))return e[t];return null}function ca(e){e.style.height="auto",e.style.height=`${e.scrollHeight}px`}function tv(e){return e?e.active?d`
      <div class="compaction-indicator compaction-indicator--active" role="status" aria-live="polite">
        ${pe.loader} ${u("chat.ui.compaction.active")}
      </div>
    `:e.completedAt&&Date.now()-e.completedAt<Ym?d`
        <div class="compaction-indicator compaction-indicator--complete" role="status" aria-live="polite">
          ${pe.check} ${u("chat.ui.compaction.done")}
        </div>
      `:w:w}function nv(){return`att-${Date.now()}-${Math.random().toString(36).slice(2,9)}`}function iv(e,t){var o;const n=(o=e.clipboardData)==null?void 0:o.items;if(!n||!t.onAttachmentsChange)return;const i=[];for(let s=0;s<n.length;s++){const r=n[s];r.type.startsWith("image/")&&i.push(r)}if(i.length!==0){e.preventDefault();for(const s of i){const r=s.getAsFile();if(!r)continue;const a=new FileReader;a.addEventListener("load",()=>{var f;const l=a.result,c={id:nv(),dataUrl:l,mimeType:r.type},p=t.attachments??[];(f=t.onAttachmentsChange)==null||f.call(t,[...p,c])}),a.readAsDataURL(r)}}}function ov(e){const t=e.attachments??[];return t.length===0?w:d`
  ...
  `}function sv(e){const t=e.uploadedFile,n=e.onFileSelect,i=e.onClearUploadedFile;if(t!=null&&t.file_name){const o=t.summaryMeta;return d`
  ...
  `}function rv(e){var E,I,N,R;const t=e.connected,n=e.sending||e.stream!==null,i=!!(e.canAbort&&e.onAbort),o=(I=(E=e.sessions)==null?void 0:E.sessions)==null?void 0:I.find(A=>A.key===e.sessionKey),s=(o==null?void 0:o.reasoningLevel)??"off",r=e.showThinking&&s!=="off",a={name:e.assistantName,avatar:e.assistantAvatar??e.assistantAvatarUrl??null},l=(((N=e.attachments)==null?void 0:N.length)??0)>0;(R=e.uploadedFile)!=null&&R.file_name;const c=e.connected?u(l?"chat.ui.compose.placeholder.withImages":"chat.ui.compose.placeholder.default"):u("chat.ui.compose.placeholder.disconnected"),p=e.splitRatio??.6,f=!!(e.sidebarOpen&&e.onCloseSidebar),g=d`
    <div
      class="chat-thread"
      role="log"
      aria-live="polite"
    ...
    >
      ${e.loading?d`
            ...
            `:w}
      ${Ul(lv(e),A=>A.key,A=>A.kind==="divider"?d`
              <div class="chat-divider" role="separator" data-ts=${String(A.timestamp)}>
                <span class="chat-divider__line"></span>
                <span class="chat-divider__label">${A.label}</span>
                <span class="chat-divider__line"></span>
              </div>
            `:A.kind==="reading-indicator"?Km(a):A.kind==="stream"?Hm(A.text,A.startedAt,e.onOpenSidebar,a):A.kind==="group"?jm(A,{onOpenSidebar:e.onOpenSidebar,showReasoning:r,assistantName:e.assistantName,assistantAvatar:a.avatar}):w)}
    </div>
  `,b=A=>{var D;A.preventDefault(),A.stopPropagation(),A.dataTransfer&&(A.dataTransfer.dropEffect="copy"),(D=e.onComposeDragOver)==null||D.call(e)},$=A=>{var D;A.preventDefault(),A.stopPropagation(),A.dataTransfer&&(A.dataTransfer.dropEffect="copy"),(D=e.onComposeDragOver)==null||D.call(e)},k=A=>{var _;const D=A.currentTarget,y=A.relatedTarget;y!=null&&(D.contains(y)||(_=e.onComposeDragLeave)==null||_.call(e))},S=A=>{var y,_,C;A.preventDefault(),A.stopPropagation(),(y=e.onComposeDragLeave)==null||y.call(e);const D=(C=(_=A.dataTransfer)==null?void 0:_.files)!=null&&C.length?ev(A.dataTransfer.files):null;D&&e.onComposeDrop&&e.onComposeDrop(D)};return d`
    <section
      ...
      >
        ...
        ${f?d`
              ...
              <div class="chat-sidebar">
                ${Vm({content:e.sidebarContent??null,error:e.sidebarError??null,onClose:e.onCloseSidebar,onViewRawText:()=>{!e.sidebarContent||!e.onOpenSidebar||e.onOpenSidebar(`\`\`\`
${e.sidebarContent}
\`\`\``)}})}
              </div>
            `:w}
  ...
  `}const da=200;function av(e){const t=[];let n=null;for(const i of e){if(i.kind!=="message"){n&&(t.push(n),n=null),t.push(i);continue}const o=mc(i.message),s=As(o.role),r=o.timestamp||Date.now();!n||n.role!==s?(n&&t.push(n),n={kind:"group",key:`group:${s}:${i.key}`,role:s,messages:[{message:i.message,key:i.key}],timestamp:r,isStreaming:!1}):n.messages.push({message:i.message,key:i.key})}return n&&t.push(n),t}function lv(e){const t=[],n=Array.isArray(e.messages)?e.messages:[],i=Array.isArray(e.toolMessages)?e.toolMessages:[],o=Math.max(0,n.length-da);o>0&&t.push({kind:"message",key:"chat:history:notice",message:{role:"system",content:`Showing last ${da} messages (${o} hidden).`,timestamp:Date.now()}});for(let s=o;s<n.length;s++){const r=n[s],a=mc(r),c=r.__openclaw;if(c&&c.kind==="compaction"){t.push({kind:"divider",key:typeof c.id=="string"?`divider:compaction:${c.id}`:`divider:compaction:${a.timestamp}:${s}`,label:u("chat.ui.compaction.divider"),timestamp:a.timestamp??Date.now()});continue}!e.showThinking&&a.role.toLowerCase()==="toolresult"||t.push({kind:"message",key:ua(r,s),message:r})}if(e.showThinking)for(let s=0;s<i.length;s++)t.push({kind:"message",key:ua(i[s],s+n.length),message:i[s]});if(e.stream!==null){const s=`stream:${e.sessionKey}:${e.streamStartedAt??"live"}`;e.stream.trim().length>0?t.push({kind:"stream",key:s,text:e.stream,startedAt:e.streamStartedAt??Date.now()}):t.push({kind:"reading-indicator",key:s})}return av(t)}function ua(e,t){const n=e,i=typeof n.toolCallId=="string"?n.toolCallId:"";if(i)return`tool:${i}`;const o=typeof n.id=="string"?n.id:"";if(o)return`msg:${o}`;const s=typeof n.messageId=="string"?n.messageId:"";if(s)return`msg:${s}`;const r=typeof n.timestamp=="number"?n.timestamp:null,a=typeof n.role=="string"?n.role:"unknown";return r!=null?`msg:${a}:${r}:${t}`:`msg:${a}:${t}`}const cv=new Set(["title","description","default","nullable"]);function dv(e){return Object.keys(e??{}).filter(n=>!cv.has(n)).length===0}function uv(e){if(e===void 0)return"";try{return JSON.stringify(e,null,2)??""}catch{return""}}const wn={chevronDown:d`
    <svg
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
  ...
  `};function Tt(e){const{schema:t,value:n,path:i,hints:o,unsupported:s,disabled:r,onPatch:a}=e,l=e.showLabel??!0,c=Te(t),p=Ee(i,o),f=(p==null?void 0:p.label)??t.title??Ze(String(i.at(-1))),g=(p==null?void 0:p.help)??t.description,b=qo(i);if(s.has(b))return d`<div class="cfg-field cfg-field--error">
      <div class="cfg-field__label">${f}</div>
      <div class="cfg-field__error">Unsupported schema node. Use Raw mode.</div>
    </div>`;if(t.anyOf||t.oneOf){const k=(t.anyOf??t.oneOf??[]).filter(A=>!(A.type==="null"||Array.isArray(A.type)&&A.type.includes("null")));if(k.length===1)return Tt({...e,schema:k[0]});const S=A=>{if(A.const!==void 0)return A.const;if(A.enum&&A.enum.length===1)return A.enum[0]},E=k.map(S),I=E.every(A=>A!==void 0);if(I&&E.length>0&&E.length<=5){const A=n??t.default;return d`
        <div class="cfg-field">
      ...
      `}return fa({...e,options:$,value:n??t.default})}if(c==="object")return fv(e);if(c==="array")return gv(e);if(c==="boolean"){const $=typeof n=="boolean"?n:typeof t.default=="boolean"?t.default:!1;return d`
    ...
    `}return c==="number"||c==="integer"?pv(e):c==="string"?pa({...e,inputType:"text"}):d`
  ...
  `}function pv(e){const{schema:t,value:n,path:i,hints:o,disabled:s,onPatch:r}=e,a=e.showLabel??!0,l=Ee(i,o),c=(l==null?void 0:l.label)??t.title??Ze(String(i.at(-1))),p=(l==null?void 0:l.help)??t.description,f=n??t.default??"",g=typeof f=="number"?f:0;return d`
    <div class="cfg-field">
  ...
  `}function fa(e){const{schema:t,value:n,path:i,hints:o,disabled:s,options:r,onPatch:a}=e,l=e.showLabel??!0,c=Ee(i,o),p=(c==null?void 0:c.label)??t.title??Ze(String(i.at(-1))),f=(c==null?void 0:c.help)??t.description,g=n??t.default,b=r.findIndex(k=>k===g||String(k)===String(g)),$="__unset__";return d`
    <div class="cfg-field">
      ${l?d`<label class="cfg-field__label">${p}</label>`:w}
      ${f?d`<div class="cfg-field__help">${f}</div>`:w}
      <select
  ...
  `}function gv(e){const{schema:t,value:n,path:i,hints:o,unsupported:s,disabled:r,onPatch:a}=e,l=e.showLabel??!0,c=Ee(i,o),p=(c==null?void 0:c.label)??t.title??Ze(String(i.at(-1))),f=(c==null?void 0:c.help)??t.description,g=Array.isArray(t.items)?t.items[0]:t.items;if(!g)return d`
      <div class="cfg-field cfg-field--error">
  ...
  `}function hv(e){const{schema:t,value:n,path:i,hints:o,unsupported:s,disabled:r,reservedKeys:a,onPatch:l}=e,c=dv(t),p=Object.entries(n??{}).filter(([f])=>!a.has(f));return d`
    <div class="cfg-map">
      <div class="cfg-map__header">
        ...
        <button
          ...
          class="cfg-map__add"
          ?disabled=${r}
          @click=${()=>{const f={...n};let g=1,b=`custom-${g}`;for(;b in f;)g+=1,b=`custom-${g}`;f[b]=c?{}:Ia(t),l(i,f)}}
        >
      ...
      ${p.length===0?d`
        ...
        <div class="cfg-map__items">
          ${p.map(([f,g])=>{const b=[...i,f],$=uv(g);return d`
              <div class="cfg-map__item">
                <div class="cfg-map__item-key">
                  <input
                    ...
                    .value=${f}
                    ?disabled=${r}
                    @change=${k=>{const S=k.target.value.trim();if(!S||S===f)return;const E={...n};S in E||(E[S]=E[f],delete E[f],l(i,E))}}
                  />
                </div>
                <div class="cfg-map__item-value">
                  ${c?d`
                        <textarea
                          ...
                          .value=${$}
                          ?disabled=${r}
                          @change=${k=>{const S=k.target,E=S.value.trim();if(!E){l(b,void 0);return}try{l(b,JSON.parse(E))}catch{S.value=$}}}
                        ></textarea>
  ...
  `},Ts={env:{label:"Environment Variables",description:"Environment variables passed to the gateway process"},update:{label:"Updates",description:"Auto-update settings and release channel"},agents:{label:"Agents",description:"Agent configurations, models, and identities"},auth:{label:"Authentication",description:"API keys and authentication profiles"},channels:{label:"Channels",description:"Messaging channels (Telegram, Discord, Slack, etc.)"},messages:{label:"Messages",description:"Message handling and routing settings"},commands:{label:"Commands",description:"Custom slash commands"},hooks:{label:"Hooks",description:"Webhooks and event hooks"},skills:{label:"Skills",description:"Skill packs and capabilities"},tools:{label:"Tools",description:"Tool configurations (browser, search, etc.)"},gateway:{label:"Gateway",description:"Gateway server settings (port, auth, binding)"},wizard:{label:"Setup Wizard",description:"Setup wizard state and history"},meta:{label:"Metadata",description:"Gateway metadata and version information"},logging:{label:"Logging",description:"Log levels and output configuration"},browser:{label:"Browser",description:"Browser automation settings"},ui:{label:"UI",description:"User interface preferences"},models:{label:"Models",description:"AI model configurations and providers"},bindings:{label:"Bindings",description:"Key bindings and shortcuts"},broadcast:{label:"Broadcast",description:"Broadcast and notification settings"},audio:{label:"Audio",description:"Audio input/output settings"},session:{label:"Session",description:"Session management and persistence"},cron:{label:"Cron",description:"Scheduled tasks and automation"},web:{label:"Web",description:"Web server and API settings"},discovery:{label:"Discovery",description:"Service discovery and networking"},canvasHost:{label:"Canvas Host",description:"Canvas rendering and display"},talk:{label:"Talk",description:"Voice and speech settings"},plugins:{label:"Plugins",description:"Plugin management and extensions"}};function ha(e){return ga[e]??ga.default}function mv(e,t,n){if(!n)return!0;const i=n.toLowerCase(),o=Ts[e];return e.toLowerCase().includes(i)||o&&(o.label.toLowerCase().includes(i)||o.description.toLowerCase().includes(i))?!0:rn(t,i)}function rn(e,t){var i,o,s;if((i=e.title)!=null&&i.toLowerCase().includes(t)||(o=e.description)!=null&&o.toLowerCase().includes(t)||(s=e.enum)!=null&&s.some(r=>String(r).toLowerCase().includes(t)))return!0;if(e.properties){for(const[r,a]of Object.entries(e.properties))if(r.toLowerCase().includes(t)||rn(a,t))return!0}if(e.items){const r=Array.isArray(e.items)?e.items:[e.items];for(const a of r)if(a&&rn(a,t))return!0}if(e.additionalProperties&&typeof e.additionalProperties=="object"&&rn(e.additionalProperties,t))return!0;const n=e.anyOf??e.oneOf??e.allOf;if(n){for(const r of n)if(r&&rn(r,t))return!0}return!1}function vv(e){var f;if(!e.schema)return d`
    ...
    <div class="config-form config-form--modern">
      ${p?(()=>{const{sectionKey:g,subsectionKey:b,schema:$}=p,k=Ee([g,b],e.uiHints),S=(k==null?void 0:k.label)??$.title??Ze(b),E=(k==null?void 0:k.help)??$.description??"",I=n[g],N=I&&typeof I=="object"?I[b]:void 0,R=`config-section-${g}-${b}`;return d`
              <section class="config-section-card" id=${R}>
                ...
                <div class="config-section-card__content">
                  ${Tt({schema:$,value:N,path:[g,b],hints:e.uiHints,unsupported:i,disabled:e.disabled??!1,showLabel:!1,onPatch:e.onPatch})}
                </div>
              </section>
            `})():c.map(([g,b])=>{const $=Ts[g]??{label:g.charAt(0).toUpperCase()+g.slice(1),description:b.description??""};return d`
  ...
  `}const yv=new Set(["title","description","default","nullable"]);function bv(e){return Object.keys(e??{}).filter(n=>!yv.has(n)).length===0}function wc(e){const t=e.filter(o=>o!=null),n=t.length!==e.length,i=[];for(const o of t)i.some(s=>Object.is(s,o))||i.push(o);return{enumValues:i,nullable:n}}function wv(e){return!e||typeof e!="object"?{schema:null,unsupportedPaths:["<root>"]}:fn(e,[])}function fn(e,t){const n=new Set,i={...e},o=qo(t)||"<root>";if(e.anyOf||e.oneOf||e.allOf){const a=$v(e,t);return a||{schema:e,unsupportedPaths:[o]}}const s=Array.isArray(e.type)&&e.type.includes("null"),r=Te(e)??(e.properties||e.additionalProperties?"object":void 0);if(i.type=r??e.type,i.nullable=s||e.nullable,i.enum){const{enumValues:a,nullable:l}=wc(i.enum);i.enum=a,l&&(i.nullable=!0),a.length===0&&n.add(o)}if(r==="object"){const a=e.properties??{},l={};for(const[c,p]of Object.entries(a)){const f=fn(p,[...t,c]);f.schema&&(l[c]=f.schema);for(const g of f.unsupportedPaths)n.add(g)}if(i.properties=l,e.additionalProperties===!0)n.add(o);else if(e.additionalProperties===!1)i.additionalProperties=!1;else if(e.additionalProperties&&typeof e.additionalProperties=="object"&&!bv(e.additionalProperties)){const c=fn(e.additionalProperties,[...t,"*"]);i.additionalProperties=c.schema??e.additionalProperties,c.unsupportedPaths.length>0&&n.add(o)}}else if(r==="array"){const a=Array.isArray(e.items)?e.items[0]:e.items;if(!a)n.add(o);else{const l=fn(a,[...t,"*"]);i.items=l.schema??a,l.unsupportedPaths.length>0&&n.add(o)}}else r!=="string"&&r!=="number"&&r!=="integer"&&r!=="boolean"&&!i.enum&&n.add(o);return{schema:i,unsupportedPaths:Array.from(n)}}function $v(e,t){if(e.allOf)return null;const n=e.anyOf??e.oneOf;if(!n)return null;const i=[],o=[];let s=!1;for(const a of n){if(!a||typeof a!="object")return null;if(Array.isArray(a.enum)){const{enumValues:l,nullable:c}=wc(a.enum);i.push(...l),c&&(s=!0);continue}if("const"in a){if(a.const==null){s=!0;continue}i.push(a.const);continue}if(Te(a)==="null"){s=!0;continue}o.push(a)}if(i.length>0&&o.length===0){const a=[];for(const l of i)a.some(c=>Object.is(c,l))||a.push(l);return{schema:{...e,enum:a,nullable:s,anyOf:void 0,oneOf:void 0,allOf:void 0},unsupportedPaths:[]}}if(o.length===1){const a=fn(o[0],t);return a.schema&&(a.schema.nullable=s||a.schema.nullable),a}const r=new Set(["string","number","integer","boolean"]);return o.length>0&&i.length===0&&o.every(a=>a.type&&r.has(String(a.type)))?{schema:{...e,nullable:s},unsupportedPaths:[]}:null}const Fo={all:d`
  ...
  `},ma=[{key:"env",label:"Environment"},{key:"update",label:"Updates"},{key:"agents",label:"Agents"},{key:"auth",label:"Authentication"},{key:"channels",label:"Channels"},{key:"messages",label:"Messages"},{key:"commands",label:"Commands"},{key:"hooks",label:"Hooks"},{key:"skills",label:"Skills"},{key:"tools",label:"Tools"},{key:"gateway",label:"Gateway"},{key:"wizard",label:"Setup Wizard"}],va="__all__";function ya(e){return Fo[e]??Fo.default}function xv(e,t){const n=Ts[e];return n||{label:(t==null?void 0:t.title)??Ze(e),description:(t==null?void 0:t.description)??""}}function kv(e){const{key:t,schema:n,uiHints:i}=e;if(!n||Te(n)!=="object"||!n.properties)return[];const o=Object.entries(n.properties).map(([s,r])=>{const a=Ee([t,s],i),l=(a==null?void 0:a.label)??r.title??Ze(s),c=(a==null?void 0:a.help)??r.description??"",p=(a==null?void 0:a.order)??50;return{key:s,label:l,description:c,order:p}});return o.sort((s,r)=>s.order!==r.order?s.order-r.order:s.key.localeCompare(r.key)),o}function Sv(e,t){if(!e||!t)return[];const n=[];function i(o,s,r){if(o===s)return;if(typeof o!=typeof s){n.push({path:r,from:o,to:s});return}if(typeof o!="object"||o===null||s===null){o!==s&&n.push({path:r,from:o,to:s});return}if(Array.isArray(o)&&Array.isArray(s)){JSON.stringify(o)!==JSON.stringify(s)&&n.push({path:r,from:o,to:s});return}const a=o,l=s,c=new Set([...Object.keys(a),...Object.keys(l)]);for(const p of c)i(a[p],l[p],r?`${r}.${p}`:p)}return i(e,t,""),n}function ba(e,t=40){let n;try{n=JSON.stringify(e)??String(e)}catch{n=String(e)}return n.length<=t?n:n.slice(0,t-3)+"..."}function _v(e){var D,y,_;const t=e.valid==null?"unknown":e.valid?"valid":"invalid",n=wv(e.schema),i=n.schema?n.unsupportedPaths.length>0:!1,o=((D=n.schema)==null?void 0:D.properties)??{},s=ma.filter(C=>C.key in o),r=new Set(ma.map(C=>C.key)),a=Object.keys(o).filter(C=>!r.has(C)).map(C=>({key:C,label:C.charAt(0).toUpperCase()+C.slice(1)})),l=[...s,...a],c=e.activeSection&&n.schema&&Te(n.schema)==="object"?(y=n.schema.properties)==null?void 0:y[e.activeSection]:void 0,p=e.activeSection?xv(e.activeSection,c):null,f=e.activeSection?kv({key:e.activeSection,schema:c,uiHints:e.uiHints}):[],g=e.formMode==="form"&&!!e.activeSection&&f.length>0,b=e.activeSubsection===va,$=e.searchQuery||b?null:e.activeSubsection??((_=f[0])==null?void 0:_.key)??null,k=e.formMode==="form"?Sv(e.originalValue,e.formValue):[],S=e.formMode==="raw"&&e.raw!==e.originalRaw,E=e.formMode==="form"?k.length>0:S,I=!!e.formValue&&!e.loading&&!!n.schema,N=e.connected&&!e.saving&&E&&(e.formMode==="raw"?!0:I),R=e.connected&&!e.applying&&!e.updating&&E&&(e.formMode==="raw"?!0:I),A=e.connected&&!e.applying&&!e.updating;return d`
        ...
        <div class="config-content">
          ${e.formMode==="form"?d`
                ${e.schemaLoading?d`
                      ...
                      `:vv({schema:n.schema,uiHints:e.uiHints,value:e.formValue,disabled:e.loading||!e.formValue,unsupportedPaths:n.unsupportedPaths,onPatch:e.onFormPatch,searchQuery:e.searchQuery,activeSection:e.activeSection,activeSubsection:$})}
                ${i?d`
...
${JSON.stringify(e.issues,null,2)}</pre
  ...
  `}function wa(e){const t=(e??"").trim();return t?t==="Untitled quotation"||t==="未命名报价单"?u("work.fallbackDraftName"):t:""}function Av(e){if(!e)return"-";try{return new Date(e).toLocaleString()}catch{return e??"-"}}function Cv(e,t,n,i){const o=i==="asc"?1:-1;if(n==="created_at"){const s=e.created_at?new Date(e.created_at).getTime():0,r=t.created_at?new Date(t.created_at).getTime():0;return(s-r)*o}return n==="name"?(e.name??"").localeCompare(t.name??"")*o:(e.draft_no??"").localeCompare(t.draft_no??"")*o}function Tv(e){const{loading:t,error:n,drafts:i,detail:o,detailId:s,confirmBusy:r,confirmResult:a,filterQuery:l,sortBy:c,sortDir:p,page:f,pageSize:g,onRefresh:b,onSelectDraft:$,onConfirm:k,onClearDetail:S,onFilterQueryChange:E,onSortByChange:I,onSortDirChange:N,onPageChange:R,onPageSizeChange:A}=e,D=l.trim().toLowerCase(),_=[...D?i.filter(O=>`${O.draft_no??""}
${O.name??""}
${O.source??""}`.toLowerCase().includes(D)):i].sort((O,ne)=>Cv(O,ne,c,p)),C=_.length,q=Math.max(1,g||10),P=Math.max(1,Math.ceil(C/q)),j=Math.min(Math.max(1,f),P),H=(j-1)*q,G=_.slice(H,H+q);return d`
                    ...
                    <tbody>
                      ${G.map(O=>d`
                          <tr style=${s===O.id?"background: var(--bg-secondary, #f5f5f5);":""}>
                            ...
                            <td style="padding: 6px 8px; border: 1px solid var(--border);">${Av(O.created_at)}</td>
  ...
  `}function Ev(e,t,n,i){const o=i==="asc"?1:-1;if(n==="uploaded_at"){const s=e.uploaded_at?new Date(e.uploaded_at).getTime():0,r=t.uploaded_at?new Date(t.uploaded_at).getTime():0;return(s-r)*o}return n==="shortfall"?(Number(e.shortfall??0)-Number(t.shortfall??0))*o:n==="count"?(Number(e.count??0)-Number(t.count??0))*o:(e.product_name??"").localeCompare(t.product_name??"")*o}function Rv(e){const{loading:t,error:n,suggestions:i,selectedKeys:o,approvedKeys:s,approveBusy:r,approveResult:a,filterQuery:l,sortBy:c,sortDir:p,page:f,pageSize:g,onRefresh:b,onToggleSelect:$,onApprove:k,onApproveBatch:S,onFilterQueryChange:E,onSortByChange:I,onSortDirChange:N,onPageChange:R,onPageSizeChange:A}=e,D=i.filter(L=>!s.includes(De(L))),y=l.trim().toLowerCase(),_=y?D.filter(L=>`${L.product_name??""}
${L.specification??""}
${L.code??""}
${L.product_key??""}`.toLowerCase().includes(y)):D,C=[..._].sort((L,Y)=>Ev(L,Y,c,p)),q=C.length,P=Math.max(1,g||10),j=Math.max(1,Math.ceil(q/P)),H=Math.min(Math.max(1,f),j),G=(H-1)*P,O=C.slice(G,G+P),ne=_.filter(L=>o.includes(De(L))).length,be=_.length>0&&_.every(L=>o.includes(De(L)));return d`
  ...
  `}function Lv(e){const t=e.status&&typeof e.status=="object"?e.status.securityAudit:null,n=(t==null?void 0:t.summary)??null,i=(n==null?void 0:n.critical)??0,o=(n==null?void 0:n.warn)??0,s=(n==null?void 0:n.info)??0,r=i>0?"danger":o>0?"warn":"success",a=i>0?`${i} critical`:o>0?`${o} warnings`:"No critical issues";return d`
    <section class="grid grid-cols-2">
      <div class="card">
        <div class="row" style="justify-content: space-between;">
          <div>
  ...
  `}function Iv(e){const t=Math.max(0,e),n=Math.floor(t/1e3);if(n<60)return`${n}s`;const i=Math.floor(n/60);return i<60?`${i}m`:`${Math.floor(i/60)}h`}function ht(e,t){return t?d`<div class="exec-approval-meta-row"><span>${e}</span><span>${t}</span></div>`:w}function Pv(e){const t=e.execApprovalQueue[0];if(!t)return w;const n=t.request,i=t.expiresAtMs-Date.now(),o=i>0?`expires in ${Iv(i)}`:"expired",s=e.execApprovalQueue.length;return d`
  ...
  `}function Dv(e){const{pendingGatewayUrl:t}=e;return t?d`
  ...
  `:w}const $a=["trace","debug","info","warn","error","fatal"];function Mv(e){if(!e)return"";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleTimeString()}function Fv(e,t){return t?[e.message,e.subsystem,e.raw].filter(Boolean).join(" ").toLowerCase().includes(t):!0}function Nv(e){const t=e.filterText.trim().toLowerCase(),n=$a.some(s=>!e.levelFilters[s]),i=e.entries.filter(s=>s.level&&!e.levelFilters[s.level]?!1:Fv(s,t)),o=t||n?"filtered":"visible";return d`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
      ...
      <div class="log-stream" style="margin-top: 12px;" @scroll=${e.onScroll}>
        ${i.length===0?d`
              ...
              `:i.map(s=>d`
                <div class="log-row">
                  <div class="log-time mono">${Mv(s.time)}</div>
  ...
  `}function Ov(e){return d`
    <section class="card">
      ...
      <div class="row" style="margin-top: 16px; gap: 12px; flex-wrap: wrap;">
        ${e.stats?Bv(e.stats):e.loading?w:d`<div class="muted">${u("oos.empty.stats")}</div>`}
      </div>
      <div style="margin-top: 24px;">
        ...
        <div class="list" style="margin-top: 8px;">
          ${e.list.length===0?d`<div class="muted">${u("oos.empty.list")}</div>`:e.list.slice(0,50).map(t=>Uv(t,e.onDelete))}
        </div>
      ...
      <div class="row" style="margin-top: 24px; gap: 24px; flex-wrap: wrap;">
        <div style="flex: 1; min-width: 200px;">
          ...
          <div class="list" style="margin-top: 8px;">
            ${e.byFile.length===0?d`<div class="muted">${u("oos.byFile.empty")}</div>`:e.byFile.slice(0,10).map(t=>zv(t))}
          </div>
        </div>
        <div style="flex: 1; min-width: 200px;">
          <div class="card-title" style="font-size: 1rem;">
          ...
          <div class="list" style="margin-top: 8px;">
            ${e.byTime.length===0?d`<div class="muted">${u("oos.byTime.empty")}</div>`:e.byTime.slice(0,10).map(t=>qv(t))}
          </div>
        </div>
      </div>
    </section>
  `}function Bv(e){return[{label:u("oos.stats.totalRecords"),value:e.total_records},{label:u("oos.stats.outOfStockCount"),value:e.out_of_stock_count},{label:u("oos.stats.today"),value:e.today_count},{label:u("oos.stats.reportedGe2"),value:e.notified_count},{label:u("oos.stats.emailSentProductCount"),value:e.email_sent_product_count}].map(n=>d`
      <div class="card stat-card" style="min-width: 100px;">
        <div class="stat-value">${n.value}</div>
        <div class="stat-label">${n.label}</div>
      </div>
    `)}function Uv(e,t){const n=e.product_name??"",i=e.specification??"",o=e.unit??"",s=e.quantity??"",r=e.count??1,a=(e.email_sent_count??0)>0||e.email_status==="sent",l=u(a?"oos.email.sent":"oos.email.notSent"),c=e.product_key??"";return d`
  ...
  `}function Kv(e){return d`
    <section class="card" style="margin-top: 24px;">
      ...
      ${e.error?d`<div class="callout danger" style="margin-top: 12px;">${e.error}</div>`:w}
      <div class="row" style="margin-top: 16px; gap: 12px; flex-wrap: wrap;">
        ${e.stats?Hv(e.stats):e.loading?w:d`<div class="muted">${u("shortage.empty.stats")}</div>`}
      </div>
      <div style="margin-top: 24px;">
        <div class="row" style="justify-content: space-between; align-items: center; margin-bottom: 8px;">
        ...
        ${e.showAddForm&&e.onAdd&&e.onCloseAddForm?d`
            ...
            `:w}
        <div class="list" style="margin-top: 8px;">
          ${e.list.length===0?d`<div class="muted">${u("shortage.empty.list")}</div>`:e.list.slice(0,50).map(t=>jv(t,e.onDelete))}
        </div>
        ${e.list.length>50?d`<div class="muted" style="margin-top: 8px;">
      ...
      <div class="row" style="margin-top: 24px; gap: 24px; flex-wrap: wrap;">
        <div style="flex: 1; min-width: 200px;">
          ...
          <div class="list" style="margin-top: 8px;">
            ${e.byFile.length===0?d`<div class="muted">${u("shortage.byFile.empty")}</div>`:e.byFile.slice(0,10).map(t=>Gv(t))}
          </div>
        </div>
        <div style="flex: 1; min-width: 200px;">
          <div class="card-title" style="font-size: 1rem;">
          ...
          <div class="list" style="margin-top: 8px;">
            ${e.byTime.length===0?d`<div class="muted">${u("shortage.byTime.empty")}</div>`:e.byTime.slice(0,10).map(t=>Wv(t))}
          </div>
        </div>
      </div>
    </section>
  `}function Hv(e){return[{label:u("shortage.stats.totalRecords"),value:e.total_records},{label:u("shortage.stats.shortageProductCount"),value:e.shortage_product_count},{label:u("shortage.stats.today"),value:e.today_count},{label:u("shortage.stats.reportedGe2"),value:e.reported_ge2_count}].map(n=>d`
      <div class="card stat-card" style="min-width: 100px;">
        <div class="stat-value">${n.value}</div>
        <div class="stat-label">${n.label}</div>
      </div>
    `)}function jv(e,t){const n=e.product_name??"",i=e.specification??"",o=e.quantity??0,s=e.available_qty??0,r=e.shortfall??0,a=e.count??1,l=e.product_key??"";return d`
    <div class="list-item" style="display: flex; justify-content: space-between; align-items: center;">
      <div class="list-main">
  ...
  `}function Gv(e){const t=e.file_name??"",n=e.total_records??0,i=e.uploaded_at?String(e.uploaded_at).length>19?String(e.uploaded_at).slice(0,10)+" "+String(e.uploaded_at).slice(11,19):String(e.uploaded_at):"";return d`
    <div class="list-item">
      <div class="list-main">
        <div class="list-title">${t}</div>
        <div class="list-sub">
  ...
  `}const st="__defaults__",xa=[{value:"deny",label:"Deny"},{value:"allowlist",label:"Allowlist"},{value:"full",label:"Full"}],Qv=[{value:"off",label:"Off"},{value:"on-miss",label:"On miss"},{value:"always",label:"Always"}];function ka(e){return e==="allowlist"||e==="full"||e==="deny"?e:"deny"}function Vv(e){return e==="always"||e==="off"||e==="on-miss"?e:"on-miss"}function Xv(e){const t=(e==null?void 0:e.defaults)??{};return{security:ka(t.security),ask:Vv(t.ask),askFallback:ka(t.askFallback??"deny"),autoAllowSkills:!!(t.autoAllowSkills??!1)}}function Jv(e){const t=(e==null?void 0:e.agents)??{},n=Array.isArray(t.list)?t.list:[],i=[];return n.forEach(o=>{if(!o||typeof o!="object")return;const s=o,r=typeof s.id=="string"?s.id.trim():"";if(!r)return;const a=typeof s.name=="string"?s.name.trim():void 0,l=s.default===!0;i.push({id:r,name:a||void 0,isDefault:l})}),i}function Yv(e,t){const n=Jv(e),i=Object.keys((t==null?void 0:t.agents)??{}),o=new Map;n.forEach(r=>o.set(r.id,r)),i.forEach(r=>{o.has(r)||o.set(r,{id:r})});const s=Array.from(o.values());return s.length===0&&s.push({id:"main",isDefault:!0}),s.sort((r,a)=>{var p,f;if(r.isDefault&&!a.isDefault)return-1;if(!r.isDefault&&a.isDefault)return 1;const l=(p=r.name)!=null&&p.trim()?r.name:r.id,c=(f=a.name)!=null&&f.trim()?a.name:a.id;return l.localeCompare(c)}),s}function Zv(e,t){return e===st?st:e&&t.some(n=>n.id===e)?e:st}function ey(e){var f;const t=e.execApprovalsForm??((f=e.execApprovalsSnapshot)==null?void 0:f.file)??null,n=!!t,i=Xv(t),o=Yv(e.configForm,t),s=ay(e.nodes),r=e.execApprovalsTarget;let a=r==="node"&&e.execApprovalsTargetNodeId?e.execApprovalsTargetNodeId:null;r==="node"&&a&&!s.some(g=>g.id===a)&&(a=null);const l=Zv(e.execApprovalsSelectedAgent,o),c=l!==st?((t==null?void 0:t.agents)??{})[l]??null:null,p=Array.isArray(c==null?void 0:c.allowlist)?c.allowlist??[]:[];return{ready:n,disabled:e.execApprovalsSaving||e.execApprovalsLoading,dirty:e.execApprovalsDirty,loading:e.execApprovalsLoading,saving:e.execApprovalsSaving,form:t,defaults:i,selectedScope:l,selectedAgent:c,agents:o,allowlist:p,target:r,targetNodeId:a,targetNodes:s,onSelectScope:e.onExecApprovalsSelectAgent,onSelectTarget:e.onExecApprovalsTargetChange,onPatch:e.onExecApprovalsPatch,onRemove:e.onExecApprovalsRemove,onLoad:e.onLoadExecApprovals,onSave:e.onSaveExecApprovals}}function ty(e){const t=e.ready,n=e.target!=="node"||!!e.targetNodeId;return d`
    <section class="card">
  ...
  `}function ny(e){const t=e.targetNodes.length>0,n=e.targetNodeId??"";return d`
    <div class="list" style="margin-top: 12px;">
      <div class="list-item">
        <div class="list-main">
  ...
  `}function sy(e){const t=["agents",e.selectedScope,"allowlist"],n=e.allowlist;return d`
  ...
  `}function ry(e,t,n){var r;const i=t.lastUsedAt?Et(t.lastUsedAt):"never",o=t.lastUsedCommand?uo(t.lastUsedCommand,120):null,s=t.lastResolvedPath?uo(t.lastResolvedPath,120):null;return d`
    <div class="list-item">
      <div class="list-main">
  ...
  `}function ay(e){const t=[];for(const n of e){if(!(Array.isArray(n.commands)?n.commands:[]).some(a=>String(a)==="system.execApprovals.get"||String(a)==="system.execApprovals.set"))continue;const s=typeof n.nodeId=="string"?n.nodeId.trim():"";if(!s)continue;const r=typeof n.displayName=="string"&&n.displayName.trim()?n.displayName.trim():s;t.push({id:s,label:r===s?s:`${r} · ${s}`})}return t.sort((n,i)=>n.label.localeCompare(i.label)),t}function ly(e){const t=fy(e),n=ey(e);return d`
    ${ty(n)}
    ${gy(t)}
    ${cy(e)}
    <section class="card">
  ...
  `}function cy(e){const t=e.devicesList??{pending:[],paired:[]},n=Array.isArray(t.pending)?t.pending:[],i=Array.isArray(t.paired)?t.paired:[];return d`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
  ...
  `}function dy(e,t){var a,l;const n=((a=e.displayName)==null?void 0:a.trim())||e.deviceId,i=typeof e.ts=="number"?Et(e.ts):"n/a",o=(l=e.role)!=null&&l.trim()?`role: ${e.role}`:"role: -",s=e.isRepair?" · repair":"",r=e.remoteIp?` · ${e.remoteIp}`:"";return d`
    <div class="list-item">
      <div class="list-main">
  ...
  `}function uy(e,t){var a;const n=((a=e.displayName)==null?void 0:a.trim())||e.deviceId,i=e.remoteIp?` · ${e.remoteIp}`:"",o=`roles: ${co(e.roles)}`,s=`scopes: ${co(e.scopes)}`,r=Array.isArray(e.tokens)?e.tokens:[];return d`
    <div class="list-item">
      <div class="list-main">
        <div class="list-title">${n}</div>
        ...
        ${r.length===0?d`
              ...
              <div style="display: flex; flex-direction: column; gap: 8px; margin-top: 6px;">
                ${r.map(l=>py(e.deviceId,l,t))}
              </div>
            `}
      </div>
    </div>
  `}function py(e,t,n){const i=t.revokedAtMs?"revoked":"active",o=`scopes: ${co(t.scopes)}`,s=Et(t.rotatedAtMs??t.createdAtMs??t.lastUsedAtMs??null);return d`
  ...
  `}function fy(e){const t=e.configForm,n=my(e.nodes),{defaultBinding:i,agents:o}=vy(t),s=!!t,r=e.configSaving||e.configFormMode==="raw";return{ready:s,disabled:r,configDirty:e.configDirty,configLoading:e.configLoading,configSaving:e.configSaving,defaultBinding:i,agents:o,nodes:n,onBindDefault:e.onBindDefault,onBindAgent:e.onBindAgent,onSave:e.onSaveBindings,onLoadConfig:e.onLoadConfig,formMode:e.configFormMode}}function gy(e){const t=e.nodes.length>0,n=e.defaultBinding??"";return d`
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
        <div>
  ...
  `}function hy(e,t){var s;const n=e.binding??"__default__",i=(s=e.name)!=null&&s.trim()?`${e.name} (${e.id})`:e.id,o=t.nodes.length>0;return d`
    <div class="list-item">
      <div class="list-main">
  ...
  `}function my(e){const t=[];for(const n of e){if(!(Array.isArray(n.commands)?n.commands:[]).some(a=>String(a)==="system.run"))continue;const s=typeof n.nodeId=="string"?n.nodeId.trim():"";if(!s)continue;const r=typeof n.displayName=="string"&&n.displayName.trim()?n.displayName.trim():s;t.push({id:s,label:r===s?s:`${r} · ${s}`})}return t.sort((n,i)=>n.label.localeCompare(i.label)),t}function vy(e){const t={id:"main",name:void 0,index:0,isDefault:!0,binding:null};if(!e||typeof e!="object")return{defaultBinding:null,agents:[t]};const i=(e.tools??{}).exec??{},o=typeof i.node=="string"&&i.node.trim()?i.node.trim():null,s=e.agents??{},r=Array.isArray(s.list)?s.list:[];if(r.length===0)return{defaultBinding:o,agents:[t]};const a=[];return r.forEach((l,c)=>{if(!l||typeof l!="object")return;const p=l,f=typeof p.id=="string"?p.id.trim():"";if(!f)return;const g=typeof p.name=="string"?p.name.trim():void 0,b=p.default===!0,k=(p.tools??{}).exec??{},S=typeof k.node=="string"&&k.node.trim()?k.node.trim():null;a.push({id:f,name:g||void 0,index:c,isDefault:b,binding:S})}),a.length===0&&a.push(t),{defaultBinding:o,agents:a}}function yy(e){const t=!!e.connected,n=!!e.paired,i=typeof e.displayName=="string"&&e.displayName.trim()||(typeof e.nodeId=="string"?e.nodeId:"unknown"),o=Array.isArray(e.caps)?e.caps:[],s=Array.isArray(e.commands)?e.commands:[];return d`
    <div class="list-item">
      <div class="list-main">
        <div class="list-title">${i}</div>
        <div class="list-sub">
  ...
  `}function by(e){var c,p;const t=(c=e.hello)==null?void 0:c.snapshot,n=t!=null&&t.uptimeMs?Ha(t.uptimeMs):u("common.na"),i=(p=t==null?void 0:t.policy)!=null&&p.tickIntervalMs?`${t.policy.tickIntervalMs}ms`:u("common.na"),s=(t==null?void 0:t.authMode)==="trusted-proxy",r=(()=>{if(e.connected||!e.lastError)return null;const f=e.lastError.toLowerCase();if(!(f.includes("unauthorized")||f.includes("connect failed")))return null;const b=!!e.settings.token.trim(),$=!!e.password.trim();return!b&&!$?d`
        <div class="muted" style="margin-top: 8px">
  ...
  `}function wy(e){var s;const t=((s=e.report)==null?void 0:s.skills)??[],n=e.filter.trim().toLowerCase(),i=n?t.filter(r=>[r.name,r.description,r.source].join(" ").toLowerCase().includes(n)):t,o=jl(i);return d`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
          <div class="card-title">Skills</div>
  ...
  `}function $y(e,t){const n=t.busyKey===e.skillKey,i=t.edits[e.skillKey]??"",o=t.messages[e.skillKey]??null,s=e.install.length>0&&e.missing.bins.length>0,r=!!(e.bundled&&e.source!=="openclaw-bundled"),a=Gl(e),l=Wl(e);return d`
    <div class="list-item">
      <div class="list-main">
  ...
  `}const xy=/^data:/i,ky=/^https?:\/\//i;function Sy(e){var a,l;const t=((a=e.agentsList)==null?void 0:a.agents)??[],n=Ba(e.sessionKey),i=(n==null?void 0:n.agentId)??((l=e.agentsList)==null?void 0:l.defaultId)??"main",o=t.find(c=>c.id===i),s=o==null?void 0:o.identity,r=(s==null?void 0:s.avatarUrl)??(s==null?void 0:s.avatar);if(r)return xy.test(r)||ky.test(r)?r:s==null?void 0:s.avatarUrl}function _y(e){var $,k,S,E,I,N,R,A,D;const t=e.presenceEntries.length,n=(($=e.sessionsResult)==null?void 0:$.count)??null,i=((k=e.cronStatus)==null?void 0:k.nextWakeAtMs)??null,o=e.connected?null:u("chat.disconnected"),s=e.tab==="chat",r=s&&(e.settings.chatFocusMode||e.onboarding),a=e.onboarding?!1:e.settings.chatShowThinking,l=Sy(e),c=e.chatAvatarUrl??l??null,p=e.configForm??((S=e.configSnapshot)==null?void 0:S.config),f=jt(e.basePath??""),g=e.agentsSelectedId??((E=e.agentsList)==null?void 0:E.defaultId)??((R=(N=(I=e.agentsList)==null?void 0:I.agents)==null?void 0:N[0])==null?void 0:R.id)??null,b=xt.getLocale();return d`
    <div class="shell ${s?"shell--chat":""} ${r?"shell--chat-focus":""} ${e.settings.navCollapsed?"shell--nav-collapsed":""} ${e.onboarding?"shell--onboarding":""}">
      ...
      <aside class="nav ${e.settings.navCollapsed?"nav--collapsed":""}">
        ${sp.map(y=>{const _=e.settings.navGroupsCollapsed[y.label]??!1,C=y.tabs.some(q=>q===e.tab);return d`
      ...
      <main class="content ${s?"content--chat":""}">
        <section class="content-header">
          <div>
            ...
            ${e.tab==="work"?w:d`<div class="page-sub">${lp(e.tab)}</div>`}
          </div>
          <div class="page-meta">
