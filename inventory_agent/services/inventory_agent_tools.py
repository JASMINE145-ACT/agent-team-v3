...
def _execute_match_wanding_price(arguments: dict[str, Any]) -> dict[str, Any]:
    ...
    """
    try:
        from inventory_agent.services.match_and_inventory import match_wanding_price_candidates
...
def _execute_select_wanding_match(arguments: dict[str, Any]) -> dict[str, Any]:
    ...
    """
    try:
        from inventory_agent.services.llm_selector import llm_select_best
...
def _execute_inventory_tool_impl(name: str, arguments: dict[str, Any]) -> dict[str, Any]:
    ...
    if name == "search_inventory":
        ...
        try:
            from inventory_agent.services.spec_extractor import extract_specs_from_query
