...
describe("handleChatEvent", () => {
  ...
  it("pushes final message before clearing stream", () => {
    const state = createState({
      sessionKey: "main",
      chatRunId: "run-1",
      chatStream: "streamed",
  ...
  it("skips final assistant message when it contains only thinking blocks", () => {
    const state = createState({
      sessionKey: "main",
      chatRunId: "run-1",
      chatStream: "streamed",
  ...
  it("clears stream on final even when message is missing", () => {
    const state = createState({
      sessionKey: "main",
      chatRunId: "run-1",
      chatStream: "streamed",
  ...
  it("skips aborted fallback message when stream is empty after trim", () => {
    const existingMessage = {
      role: "user",
      content: [{ type: "text", text: "Hi" }],
      timestamp: 1,
